...
func (_c *Syncer_Enabled_Call) RunAndReturn(run func() bool) *Syncer_Enabled_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *Syncer_GetName_Call) RunAndReturn(run func() string) *Syncer_GetName_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *Syncer_GetPeriod_Call) RunAndReturn(run func() time.Duration) *Syncer_GetPeriod_Call {
	_c.Call.Return(run)
	return _c
}
