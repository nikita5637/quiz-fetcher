...
func (_m *PlaceStorage) GetPlaceByNameAndAddress(ctx context.Context, name string, address string) (mysql.Place, error) {
	...
	var r0 mysql.Place
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (mysql.Place, error)); ok {
		return rf(ctx, name, address)
	}
...
func (_c *PlaceStorage_GetPlaceByNameAndAddress_Call) RunAndReturn(run func(context.Context, string, string) (mysql.Place, error)) *PlaceStorage_GetPlaceByNameAndAddress_Call {
	_c.Call.Return(run)
	return _c
}
