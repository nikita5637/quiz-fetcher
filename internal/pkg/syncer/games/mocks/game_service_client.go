...
func (_m *GameServiceClient) CreateGame(ctx context.Context, in *game.CreateGameRequest, opts ...grpc.CallOption) (*game.Game, error) {
	...
	var r0 *game.Game
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *game.CreateGameRequest, ...grpc.CallOption) (*game.Game, error)); ok {
...
func (_c *GameServiceClient_CreateGame_Call) RunAndReturn(run func(context.Context, *game.CreateGameRequest, ...grpc.CallOption) (*game.Game, error)) *GameServiceClient_CreateGame_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *GameServiceClient) PatchGame(ctx context.Context, in *game.PatchGameRequest, opts ...grpc.CallOption) (*game.Game, error) {
	...
	var r0 *game.Game
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *game.PatchGameRequest, ...grpc.CallOption) (*game.Game, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_c *GameServiceClient_PatchGame_Call) RunAndReturn(run func(context.Context, *game.PatchGameRequest, ...grpc.CallOption) (*game.Game, error)) *GameServiceClient_PatchGame_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *GameServiceClient) SearchGamesByLeagueID(ctx context.Context, in *game.SearchGamesByLeagueIDRequest, opts ...grpc.CallOption) (*game.SearchGamesByLeagueIDResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *game.SearchGamesByLeagueIDRequest, ...grpc.CallOption) (*game.SearchGamesByLeagueIDResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
...
func (_c *GameServiceClient_SearchGamesByLeagueID_Call) RunAndReturn(run func(context.Context, *game.SearchGamesByLeagueIDRequest, ...grpc.CallOption) (*game.SearchGamesByLeagueIDResponse, error)) *GameServiceClient_SearchGamesByLeagueID_Call {
	_c.Call.Return(run)
	return _c
}
