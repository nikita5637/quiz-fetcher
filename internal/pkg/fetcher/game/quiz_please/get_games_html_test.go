...
const (
	html1 = `<html lang="ru-RU" prefix="og: https://ogp.me/ns#" data-wf-page="5c03f3a675885307fa079589" data-wf-site="5bc0ac8287e732c8a80650db" class=" w-mod-js"><head>
	<!-- Google Tag Manager -->
	<script type="text/javascript" async="" src="https://analytics.tiktok.com/i18n/pixel/static/main.MWE2YWY2YTgzMA.js" data-id="BSLTES8FTC5NUJCR9HH0"></script><script type="text/javascript" async="" src="https://analytics.tiktok.com/i18n/pixel/sdk.js?sdkid=BSLTES8FTC5NUJCR9HH0"></script><script type="text/javascript" async="" src="https://mc.yandex.ru/metrika/watch.js"></script><script src="https://connect.facebook.net/signals/config/1953660694758081?v=2.9.92&amp;r=stable" async=""></script><script async="" src="https://connect.facebook.net/en_US/fbevents.js"></script><script>
	    (function (w, d, s, l, i) {
		w[l] = w[l] || [];
	    ...
	    })(window, document, 'script', 'dataLayer', GTM-K29PN9H);
	</script>
	<!-- End Google Tag Manager -->
	<!-- Google Analytics -->
		    <script>
		    window.ga=window.ga||function(){(ga.q=ga.q||[]).push(arguments)};ga.l=+new Date;
		    ga('create', 'UA-126809792-1', 'auto');
		    ga('send', 'pageview');
		    </script>
	...
	<meta charset="UTF-8">
	    <link href="/libs/owl/assets/owl.carousel.min.css" rel="stylesheet" position="1">
    <link href="/libs/owl/assets/owl.theme.default.min.css" rel="stylesheet" position="1">
    <link href="/libs/air-datapicker/style.css" rel="stylesheet" position="1">
    <link href="/assets/72b6f059/css/bootstrap.min.css" rel="stylesheet">
    <link href="/themes/webant/css/flexboxgrid.css" rel="stylesheet">
    <link href="/themes/webant/css/form.css" rel="stylesheet">
    <link href="/themes/webant/css/footer2.css?19112021" rel="stylesheet">
    <script src="/libs/vue/vue.js"></script>
    <script src="/libs/air-datapicker/index.js"></script>
    <script src="/libs/intl-tel-17/js/utils.js"></script>
		<title>Расписание игр</title>
	<meta content="width=device-width, initial-scale=1" name="viewport">
	<meta name="msapplication-TileColor" content="#ffffff">
	<meta name="msapplication-TileImage" content="/ms-icon-144x144.png">
	<meta property="og:description" content="Интеллектуальные игры в барах каждую неделю. Регистрируйтесь! Мы очень внимательно следим за безопасностью на играх.">
	<meta name="description" content="Интеллектуальные игры в барах каждую неделю. Регистрируйтесь! Мы очень внимательно следим за безопасностью на играх.">
    
	<link rel="stylesheet" href="/libs/magnific-popup/magnific-popup.css?1673951694">
	<link rel="stylesheet" href="/libs/ion.rangeSlider.css?1673951694">
	<link rel="stylesheet" href="/themes/b4/libs/font-awesome-4.7.0/css/font-awesome.min.css">
	<link href="/themes/b4/libs/datepicker/datepicker.min.css" rel="stylesheet">
	<link rel="stylesheet" type="text/css" href="/themes/b4/libs/slick/slick.css">
	<link rel="stylesheet" type="text/css" href="/themes/b4/libs/slick/slick-theme.css">
	<link rel="stylesheet" href="/themes/b4/css/menu2.css?1673951694">
	<link rel="stylesheet" href="/css/header2.css?1673951694">
    
    
	<link href="/css/bootstrap-grid.min2.css" rel="stylesheet">
	<link href="/css/icon2.css" rel="stylesheet">
	<link href="/themes/b4/css/normalize3.css" rel="stylesheet" type="text/css">
	<link href="/themes/b4/css/webflow3.css?19032020" rel="stylesheet" type="text/css">
	<link href="/themes/b4/css/quiz-please.webflow4.css?1673951694" rel="stylesheet" type="text/css">
	<link href="/libs/intl-tel-16/css/intlTelInput.css" rel="stylesheet">
	<link rel="stylesheet" href="/themes/b4/css/bars-square.css">
    ...
    <script>
      ...
      fbq('init', '1953660694758081');
      fbq('track', 'PageView');
    </script>
    <noscript>&lt;img height="1" width="1" style="display:none"
      src="https://www.facebook.com/tr?id=1953660694758081&amp;ev=PageView&amp;noscript=1"
    /&gt;</noscript>
    <!-- End Facebook Pixel Code -->
    
    <script type="text/javascript">!function(){var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src="https://vk.com/js/api/openapi.js?168",t.onload=function(){VK.Retargeting.Init("VK-RTRG-425456-6vG4p"),VK.Retargeting.Hit()},document.head.appendChild(t)}();</script><script type="text/javascript" async="" src="https://vk.com/js/api/openapi.js?168"></script><noscript>&lt;img src="https://vk.com/rtrg?p=VK-RTRG-425456-6vG4p" style="position:fixed; left:-999px;" alt=""/&gt;</noscript>
	<style>
	    .game-buttons {
		align-items: center;
		flex-direction: row;
	...
	function getCookie(name) {
	  ...
	  return matches ? decodeURIComponent(matches[1]) : undefined;
	    ...
	    // todo брать из cookies
	    window.city_id = getCookie('city')
    
	function callAnalytics(...args) {
	    if (typeof yaCounter35711540 !== 'undefined') {
		if (args[0]){
		    yaCounter35711540.reachGoal(args[0])
		}
	    }
	    //saratov = 63
	    if (typeof yaCounter80130940 !== 'undefined' && window.city_id == 'saratov') {
		if (args[0]){
		    yaCounter80130940.reachGoal(args[0])
		}
	    }
    ...
    </style><script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/51/5/common.js"></script><script type="text/javascript" charset="UTF-8" src="https://maps.googleapis.com/maps-api-v3/api/js/51/5/util.js"></script></head>
    <body>
    
    <div>
	
	
	<div class="fixed-navbar navbar-2 w-nav" data-collapse="medium" data-animation="default" data-duration="0" style="display: none; transition: opacity 100ms ease 0s; opacity: 0;">
	    <div class="container container-navbar">
		<a href="/" class="brand-navbar w-nav-brand">
		    <img src="/themes/b4/images/logo-dark.svg" width="78" alt="" class="logo-brand">
		</a>
    
				<div data-delay="0" class="city-drop-main w-dropdown">
			<div class="city-drop-tog fixed-navbar-drop w-clearfix w-dropdown-toggle"><img src="themes/b4/images/pin-grey.svg" alt="" class="pin-icon">
			    <div class="city-drop-text">Санкт-Петербург</div>
			</div>
    
			
			<nav class="main-city-droplist full-list w-dropdown-list">
			    <div class="h3 h3-city-drop">В Квиз, плиз! можно поиграть в 21 стране и                            132 городах</div>
			    <div class="w-layout-grid city-grid">
				<div id="w-node-8cee8f9579e0-15280726" class="city-droplist-column">
				    <ul><li class="h4 h4-mb6 country-name">Россия</li><li class="" data-slug="spb"><a class="city-droplink w-dropdown-link" href="https://spb.quizplease.ru/schedule">Санкт-Петербург</a></li><li data-slug="abakan"><a class="city-droplink w-dropdown-link" href="https://abakan.quizplease.ru/schedule">Абакан</a></li><li data-slug="almet"><a class="city-droplink w-dropdown-link" href="https://almet.quizplease.ru/schedule">Альметьевск</a></li><li data-slug="anadyr"><a class="city-droplink w-dropdown-link" href="https://anadyr.quizplease.ru/schedule">Анадырь</a></li><li data-slug="bal"><a class="city-droplink w-dropdown-link" href="https://bal.quizplease.ru/schedule">Балаково</a></li><li data-slug="brn"><a class="city-droplink w-dropdown-link" href="https://brn.quizplease.ru/schedule">Барнаул</a></li><li data-slug="blg"><a class="city-droplink w-dropdown-link" href="https://blg.quizplease.ru/schedule">Благовещенск</a></li><li data-slug="bryansk"><a class="city-droplink w-dropdown-link" href="https://bryansk.quizplease.ru/schedule">Брянск</a></li><li data-slug="vnovgorod"><a class="city-droplink w-dropdown-link" href="https://vnovgorod.quizplease.ru/schedule">Великий Новгород</a></li><li data-slug="vdk"><a class="city-droplink w-dropdown-link" href="https://vdk.quizplease.ru/schedule">Владивосток</a></li><li data-slug="vldz"><a class="city-droplink w-dropdown-link" href="https://vldz.quizplease.ru/schedule">Владикавказ</a></li><li data-slug="vld"><a class="city-droplink w-dropdown-link" href="https://vld.quizplease.ru/schedule">Владимир</a></li><li data-slug="vlg"><a class="city-droplink w-dropdown-link" href="https://vlg.quizplease.ru/schedule">Волгоград</a></li><li data-slug="vdonsk"><a class="city-droplink w-dropdown-link" href="https://vdonsk.quizplease.ru/schedule">Волгодонск</a></li><li data-slug="vlz"><a class="city-droplink w-dropdown-link" href="https://vlz.quizplease.ru/schedule">Волжский</a></li><li data-slug="vologda"><a class="city-droplink w-dropdown-link" href="https://vologda.quizplease.ru/schedule">Вологда</a></li><li data-slug="vrn"><a class="city-droplink w-dropdown-link" href="https://vrn.quizplease.ru/schedule">Воронеж</a></li><li data-slug="vtk"><a class="city-droplink w-dropdown-link" href="https://vtk.quizplease.ru/schedule">Воткинск</a></li><li data-slug="galt"><a class="city-droplink w-dropdown-link" href="https://galt.quizplease.ru/schedule">Горно-Алтайск</a></li><li data-slug="ekb"><a class="city-droplink w-dropdown-link" href="https://ekb.quizplease.ru/schedule">Екатеринбург</a></li><li data-slug="essentuki"><a class="city-droplink w-dropdown-link" href="https://essentuki.quizplease.ru/schedule">Ессентуки</a></li><li data-slug="izh"><a class="city-droplink w-dropdown-link" href="https://izh.quizplease.ru/schedule">Ижевск</a></li><li data-slug="irk"><a class="city-droplink w-dropdown-link" href="https://irk.quizplease.ru/schedule">Иркутск</a></li><li data-slug="yo"><a class="city-droplink w-dropdown-link" href="https://yo.quizplease.ru/schedule">Йошкар-Ола</a></li><li data-slug="kzn"><a class="city-droplink w-dropdown-link" href="https://kzn.quizplease.ru/schedule">Казань</a></li><li data-slug="kgd"><a class="city-droplink w-dropdown-link" href="https://kgd.quizplease.ru/schedule">Калининград</a></li><li data-slug="klg"><a class="city-droplink w-dropdown-link" href="https://klg.quizplease.ru/schedule">Калуга</a></li><li data-slug="kem"><a class="city-droplink w-dropdown-link" href="https://kem.quizplease.ru/schedule">Кемерово</a></li><li data-slug="kirov"><a class="city-droplink w-dropdown-link" href="https://kirov.quizplease.ru/schedule">Киров</a></li><li data-slug="kms"><a class="city-droplink w-dropdown-link" href="https://kms.quizplease.ru/schedule">Комсомольск-на-Амуре</a></li><li data-slug="krd"><a class="city-droplink w-dropdown-link" href="https://krd.quizplease.ru/schedule">Краснодар</a></li><li data-slug="krs"><a class="city-droplink w-dropdown-link" href="https://krs.quizplease.ru/schedule">Красноярск</a></li><li data-slug="lip"><a class="city-droplink w-dropdown-link" href="https://lip.quizplease.ru/schedule">Липецк</a></li><li data-slug="mgdn"><a class="city-droplink w-dropdown-link" href="https://mgdn.quizplease.ru/schedule">Магадан</a></li><li data-slug="moscow"><a class="city-droplink w-dropdown-link" href="https://moscow.quizplease.ru/schedule">Москва</a></li><li data-slug="chelny"><a class="city-droplink w-dropdown-link" href="https://chelny.quizplease.ru/schedule">Набережные Челны</a></li><li data-slug="nhk"><a class="city-droplink w-dropdown-link" href="https://nhk.quizplease.ru/schedule">Находка</a></li><li data-slug="nef"><a class="city-droplink w-dropdown-link" href="https://nef.quizplease.ru/schedule">Нефтекамск</a></li><li data-slug="nv"><a class="city-droplink w-dropdown-link" href="https://nv.quizplease.ru/schedule">Нижневартовск</a></li><li data-slug="nk"><a class="city-droplink w-dropdown-link" href="https://nk.quizplease.ru/schedule">Нижнекамск</a></li><li data-slug="nn"><a class="city-droplink w-dropdown-link" href="https://nn.quizplease.ru/schedule">Нижний Новгород</a></li><li data-slug="novokuznetsk"><a class="city-droplink w-dropdown-link" href="https://novokuznetsk.quizplease.ru/schedule">Новокузнецк</a></li><li data-slug="nvr"><a class="city-droplink w-dropdown-link" href="https://nvr.quizplease.ru/schedule">Новороссийск</a></li><li data-slug="nsk"><a class="city-droplink w-dropdown-link" href="https://nsk.quizplease.ru/schedule">Новосибирск</a></li><li data-slug="nur"><a class="city-droplink w-dropdown-link" href="https://nur.quizplease.ru/schedule">Новый Уренгой</a></li><li data-slug="nbk"><a class="city-droplink w-dropdown-link" href="https://nbk.quizplease.ru/schedule">Ноябрьск</a></li><li data-slug="obn"><a class="city-droplink w-dropdown-link" href="https://obn.quizplease.ru/schedule">Обнинск</a></li><li data-slug="okt"><a class="city-droplink w-dropdown-link" href="https://okt.quizplease.ru/schedule">Октябрьский</a></li><li data-slug="omsk"><a class="city-droplink w-dropdown-link" href="https://omsk.quizplease.ru/schedule">Омск</a></li><li data-slug="orenburg"><a class="city-droplink w-dropdown-link" href="https://orenburg.quizplease.ru/schedule">Оренбург</a></li><li data-slug="penza"><a class="city-droplink w-dropdown-link" href="https://penza.quizplease.ru/schedule">Пенза</a></li><li data-slug="perm"><a class="city-droplink w-dropdown-link" href="https://perm.quizplease.ru/schedule">Пермь</a></li><li data-slug="ptz"><a class="city-droplink w-dropdown-link" href="https://ptz.quizplease.ru/schedule">Петрозаводск</a></li><li data-slug="pk"><a class="city-droplink w-dropdown-link" href="https://pk.quizplease.ru/schedule">Петропавловск-Камчатский</a></li><li data-slug="pskov"><a class="city-droplink w-dropdown-link" href="https://pskov.quizplease.ru/schedule">Псков</a></li><li data-slug="pyatigorsk"><a class="city-droplink w-dropdown-link" href="https://pyatigorsk.quizplease.ru/schedule">Пятигорск</a></li><li data-slug="rostov"><a class="city-droplink w-dropdown-link" href="https://rostov.quizplease.ru/schedule">Ростов-на-Дону</a></li><li data-slug="smr"><a class="city-droplink w-dropdown-link" href="https://smr.quizplease.ru/schedule">Самара</a></li><li data-slug="srn"><a class="city-droplink w-dropdown-link" href="https://srn.quizplease.ru/schedule">Саранск</a></li><li data-slug="srpl"><a class="city-droplink w-dropdown-link" href="https://srpl.quizplease.ru/schedule">Сарапул</a></li><li data-slug="saratov"><a class="city-droplink w-dropdown-link" href="https://saratov.quizplease.ru/schedule">Саратов</a></li><li data-slug="svb"><a class="city-droplink w-dropdown-link" href="https://svb.quizplease.ru/schedule">Свободный</a></li><li data-slug="sochi"><a class="city-droplink w-dropdown-link" href="https://sochi.quizplease.ru/schedule">Сочи</a></li><li data-slug="stav"><a class="city-droplink w-dropdown-link" href="https://stav.quizplease.ru/schedule">Ставрополь</a></li><li data-slug="str"><a class="city-droplink w-dropdown-link" href="https://str.quizplease.ru/schedule">Стерлитамак</a></li><li data-slug="sktv"><a class="city-droplink w-dropdown-link" href="https://sktv.quizplease.ru/schedule">Сыктывкар</a></li><li data-slug="tagan"><a class="city-droplink w-dropdown-link" href="https://tagan.quizplease.ru/schedule">Таганрог</a></li><li data-slug="tmb"><a class="city-droplink w-dropdown-link" href="https://tmb.quizplease.ru/schedule">Тамбов</a></li><li data-slug="tlt"><a class="city-droplink w-dropdown-link" href="https://tlt.quizplease.ru/schedule">Тольятти</a></li><li data-slug="tomsk"><a class="city-droplink w-dropdown-link" href="https://tomsk.quizplease.ru/schedule">Томск</a></li><li data-slug="tula"><a class="city-droplink w-dropdown-link" href="https://tula.quizplease.ru/schedule">Тула</a></li><li data-slug="tmn"><a class="city-droplink w-dropdown-link" href="https://tmn.quizplease.ru/schedule">Тюмень</a></li><li data-slug="uss"><a class="city-droplink w-dropdown-link" href="https://uss.quizplease.ru/schedule">Уссурийск</a></li><li data-slug="ufa"><a class="city-droplink w-dropdown-link" href="https://ufa.quizplease.ru/schedule">Уфа</a></li><li data-slug="ukhta"><a class="city-droplink w-dropdown-link" href="https://ukhta.quizplease.ru/schedule">Ухта</a></li><li data-slug="khv"><a class="city-droplink w-dropdown-link" href="https://khv.quizplease.ru/schedule">Хабаровск</a></li><li data-slug="cheb"><a class="city-droplink w-dropdown-link" href="https://cheb.quizplease.ru/schedule">Чебоксары</a></li><li data-slug="che"><a class="city-droplink w-dropdown-link" href="https://che.quizplease.ru/schedule">Челябинск</a></li><li data-slug="chita"><a class="city-droplink w-dropdown-link" href="https://chita.quizplease.ru/schedule">Чита</a></li><li data-slug="shahty"><a class="city-droplink w-dropdown-link" href="https://shahty.quizplease.ru/schedule">Шахты</a></li><li data-slug="eng"><a class="city-droplink w-dropdown-link" href="https://eng.quizplease.ru/schedule">Энгельс</a></li><li data-slug="sakh"><a class="city-droplink w-dropdown-link" href="https://sakh.quizplease.ru/schedule">Южно-Сахалинск</a></li><li data-slug="yar"><a class="city-droplink w-dropdown-link" href="https://yar.quizplease.ru/schedule">Ярославль</a></li><li class="city-droplink w-dropdown-link" style="font-weight:100; font-style: italic;">Республика Крым</li><li data-slug="svs"><a class="city-droplink w-dropdown-link" href="https://svs.quizplease.ru/schedule">Севастополь</a></li><li data-slug="simf"><a class="city-droplink w-dropdown-link" href="https://simf.quizplease.ru/schedule">Симферополь</a></li><li class="h4 h4-mb6 country-name">Азербайджан</li><li data-slug="baku"><a class="city-droplink w-dropdown-link" href="https://baku.quizplease.ru/schedule">Баку</a></li><li class="h4 h4-mb6 country-name">Армения</li><li data-slug="yerevan"><a class="city-droplink w-dropdown-link" href="https://yerevan.quizplease.ru/schedule">Ереван</a></li><li class="h4 h4-mb6 country-name">Беларусь</li><li data-slug="brest"><a class="city-droplink w-dropdown-link" href="https://brest.quizplease.ru/schedule">Брест</a></li><li data-slug="minsk"><a class="city-droplink w-dropdown-link" href="https://minsk.quizplease.ru/schedule">Минск</a></li><li class="h4 h4-mb6 country-name">Великобритания</li><li data-slug="lnd"><a class="city-droplink w-dropdown-link" href="https://lnd.quizplease.ru/schedule">Лондон</a></li><li class="h4 h4-mb6 country-name">Германия</li><li data-slug="berlin"><a class="city-droplink w-dropdown-link" href="https://berlin.quizplease.de/schedule/schedule">Берлин</a></li><li class="h4 h4-mb6 country-name">Грузия</li><li data-slug="batumi"><a class="city-droplink w-dropdown-link" href="https://batumi.quizplease.ru/schedule">Батуми</a></li><li data-slug="tbilisi"><a class="city-droplink w-dropdown-link" href="https://tbilisi.quizplease.ru/schedule">Тбилиси</a></li><li class="h4 h4-mb6 country-name">Израиль</li><li data-slug="beer"><a class="city-droplink w-dropdown-link" href="https://beer.quizplease.ru/schedule">Беэр-Шева</a></li><li data-slug="jrs"><a class="city-droplink w-dropdown-link" href="https://jrs.quizplease.ru/schedule">Иерусалим</a></li><li data-slug="tlv"><a class="city-droplink w-dropdown-link" href="https://tlv.quizplease.ru/schedule">Тель-Авив</a></li><li data-slug="haifa"><a class="city-droplink w-dropdown-link" href="https://haifa.quizplease.ru/schedule">Хайфа</a></li><li class="h4 h4-mb6 country-name">Индонезия</li><li data-slug="bali"><a class="city-droplink w-dropdown-link" href="https://bali.quizplease.ru/schedule">Бали</a></li><li class="h4 h4-mb6 country-name">Казахстан</li><li data-slug="aktau"><a class="city-droplink w-dropdown-link" href="https://aktau.quizplease.ru/schedule">Актау</a></li><li data-slug="aktobe"><a class="city-droplink w-dropdown-link" href="https://aktobe.quizplease.ru/schedule">Актобе</a></li><li data-slug="almaty"><a class="city-droplink w-dropdown-link" href="https://almaty.quizplease.ru/schedule">Алматы</a></li><li data-slug="astana"><a class="city-droplink w-dropdown-link" href="https://astana.quizplease.ru/schedule">Астана</a></li><li data-slug="atyrau"><a class="city-droplink w-dropdown-link" href="https://atyrau.quizplease.ru/schedule">Атырау</a></li><li data-slug="krg"><a class="city-droplink w-dropdown-link" href="https://krg.quizplease.ru/schedule">Караганда</a></li><li data-slug="pvl"><a class="city-droplink w-dropdown-link" href="https://pvl.quizplease.ru/schedule">Павлодар</a></li><li data-slug="semey"><a class="city-droplink w-dropdown-link" href="https://semey.quizplease.ru/schedule">Семей</a></li><li data-slug="taraz"><a class="city-droplink w-dropdown-link" href="https://taraz.quizplease.ru/schedule">Тараз</a></li><li data-slug="tmr"><a class="city-droplink w-dropdown-link" href="https://tmr.quizplease.ru/schedule">Темиртау</a></li><li data-slug="uralsk"><a class="city-droplink w-dropdown-link" href="https://uralsk.quizplease.ru/schedule">Уральск</a></li><li data-slug="ukg"><a class="city-droplink w-dropdown-link" href="https://ukg.quizplease.ru/schedule">Усть-Каменогорск</a></li><li data-slug="shymkent"><a class="city-droplink w-dropdown-link" href="https://shymkent.quizplease.ru/schedule">Шымкент</a></li><li class="h4 h4-mb6 country-name">Канада</li><li data-slug="mtl"><a class="city-droplink w-dropdown-link" href="https://mtl.quizplease.ru/schedule">Монреаль</a></li><li data-slug="gta"><a class="city-droplink w-dropdown-link" href="https://gta.quizplease.ru/schedule">Торонто</a></li><li class="h4 h4-mb6 country-name">Кипр</li><li data-slug="lms"><a class="city-droplink w-dropdown-link" href="https://lms.quizplease.ru/schedule">Лимассол</a></li><li class="h4 h4-mb6 country-name">Киргизия</li><li data-slug="bishkek"><a class="city-droplink w-dropdown-link" href="https://bishkek.quizplease.ru/schedule">Бишкек</a></li><li class="h4 h4-mb6 country-name">Китай</li><li data-slug="bj"><a class="city-droplink w-dropdown-link" href="https://bj.quizplease.ru/schedule">Пекин</a></li><li data-slug="shanghai"><a class="city-droplink w-dropdown-link" href="https://shanghai.quizplease.ru/schedule">Шанхай</a></li><li class="h4 h4-mb6 country-name">Латвия</li><li data-slug="riga"><a class="city-droplink w-dropdown-link" href="https://riga.quizplease.ru/schedule">Рига</a></li><li class="h4 h4-mb6 country-name">Республика Корея</li><li data-slug="ansan"><a class="city-droplink w-dropdown-link" href="https://ansan.quizplease.ru/schedule">Ансан</a></li><li data-slug="incheon"><a class="city-droplink w-dropdown-link" href="https://incheon.quizplease.ru/schedule">Инчхон</a></li><li data-slug="seoul"><a class="city-droplink w-dropdown-link" href="https://seoul.quizplease.ru/schedule">Сеул</a></li><li class="h4 h4-mb6 country-name">США</li><li data-slug="boston"><a class="city-droplink w-dropdown-link" href="https://boston.quizplease.ru/schedule">Бостон</a></li><li data-slug="miami"><a class="city-droplink w-dropdown-link" href="https://miami.quizplease.ru/schedule">Майами</a></li><li data-slug="nyc"><a class="city-droplink w-dropdown-link" href="https://nyc.quizplease.ru/schedule">Нью-Йорк</a></li><li data-slug="phi"><a class="city-droplink w-dropdown-link" href="https://phi.quizplease.ru/schedule">Филадельфия</a></li><li class="h4 h4-mb6 country-name">Таиланд</li><li data-slug="phuket"><a class="city-droplink w-dropdown-link" href="https://phuket.quizplease.ru/schedule">Пхукет</a></li><li class="h4 h4-mb6 country-name">Турция</li><li data-slug="alanya"><a class="city-droplink w-dropdown-link" href="https://alanya.quizplease.ru/schedule">Аланья</a></li><li data-slug="antalya"><a class="city-droplink w-dropdown-link" href="https://antalya.quizplease.ru/schedule">Анталья</a></li><li data-slug="mersin"><a class="city-droplink w-dropdown-link" href="https://mersin.quizplease.ru/schedule">Мерсин</a></li><li data-slug="istanbul"><a class="city-droplink w-dropdown-link" href="https://istanbul.quizplease.ru/schedule">Стамбул</a></li><li class="h4 h4-mb6 country-name">Узбекистан</li><li data-slug="tashkent"><a class="city-droplink w-dropdown-link" href="https://tashkent.quizplease.ru/schedule">Ташкент</a></li><li class="h4 h4-mb6 country-name">Черногория</li><li data-slug="budva"><a class="city-droplink w-dropdown-link" href="https://budva.quizplease.ru/schedule">Будва</a></li></ul>                            </div>
			    </div>
			</nav>
		    </div>
		
		
    <nav role="navigation" class="menu-navbar w-nav-menu">
	
		<a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content')" href="/schedule" class="link-navbar w-inline-block w--current">
		<div>Расписание</div>
	    </a>
	    <a href="/rating" class="link-navbar w-inline-block">
		<div>Рейтинг команд</div>
	    </a>
	    <a href="/shop" class="link-navbar w-inline-block">
		<div>Магазин</div>
	    </a>
	    <a href="https://franch.quizplease.ru" class="link-navbar w-inline-block">
		<div>Франшиза</div>
	    </a>
	    <a href="/corp" class="link-navbar w-inline-block">
		<div>Корпоративы</div>
	    </a>
	    <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content')" href="/home-game" class="link-navbar w-inline-block">
		<div>Игры Хоум</div>
	    </a>
    
			<a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content')" href="/stream-page" class="link-navbar w-inline-block">
		    <div>Стримы</div>
		</a>
	    
		</nav>
    
		<div class="menu-button w-clearfix w-nav-button"><img src="themes/b4/images/burger-dark.svg" alt="" class=""></div>
	    </div>
    
	    <div class="w-nav-overlay" data-wf-ignore=""></div>
	<div class="w-nav-overlay" data-wf-ignore=""></div></div>
	<main class="section section-header">
	    <style>
	.link-navbar > div {
    ...
    <div data-collapse="medium" data-animation="default" data-duration="0" class="navbar navbar-mb40 w-nav" data-ix="fixed-navbar">
		<div class="container container-navbar">
		<a href="/" class="brand-navbar w-nav-brand">
		    <img src="/img/header-logo-white-2.png" width="78" alt="" class="logo-brand">
		</a>
    
				<div class="header-region">
			<div data-delay="0" class="city-drop-main w-dropdown">
			    <div class="city-drop-tog w-clearfix w-dropdown-toggle"><img src="/themes/b4/images/pin-white.svg" alt="" class="pin-icon">
				<div class="city-drop-text">Санкт-Петербург</div>
			    </div>
    ...
    <nav role="navigation" class="menu-navbar w-nav-menu">
		...
		<div class="menu-button w-clearfix w-nav-button">
		    <img src="https://uploads-ssl.webflow.com/5aec19d3d0dbd4abd7502c14/5aef14ae6154a8fce9b2b60f_burger-white.svg" alt="" class="">
		</div>
	    </div>
    ...
    <link rel="stylesheet" href="themes/webant/css/place-info.css?1673951694">
    <link rel="stylesheet" href="themes/webant/css/game-days-left.css?1673951694">
    <link rel="stylesheet" href="magnific-popup/magnific-popup.css">
    
    <style>
	.checkbox-block input:checked+.checkbox-button {
	    background: #ffd902 5px no-repeat;
	    box-shadow: inset 0 0 0px 4px #291A3E;
	    border-radius: 3px;
	}
	...
	.seats>.filter-radio .checkbox-block input:checked+.checkbox-button {
	    background: #2ae2a4 5px no-repeat !important;
	    box-shadow: inset 0 0 0px 4px #291A3E;
	    border-radius: 3px;
	}
    
	.seats>.filter-radio .checkbox-button {
	...
	@media (min-width: 992px) and (max-width: 1154px) {
	    .button.button-green.button-left.button-small {
		width: 100% !important;
	    ...
	    .button.button-green.button-left.button-small-line {
		width: 100% !important;
		text-align: center !important;
	    }
    
	    .button.button-pink.button-left.button-small {
		width: 100% !important;
		margin-right: 0px !important;
		margin-bottom: 15px !important;
		text-align: center !important;
	    ...
	    .button.button-pink.button-left.button-small-line {
		width: 100% !important;
		text-align: center !important;
	    }
    
	    .button.button-yellow.button-left.button-small {
		width: 100% !important;
		margin-right: 0px !important;
		margin-bottom: 15px !important;
		text-align: center !important;
	    ...
	    .button.button-yellow.button-left.button-small-line {
		width: 100% !important;
		text-align: center !important;
	    }
	}
	...
	/* Решает проблему с белым кодом внизу страницы на больших экранах */
	.section {
	...
	@media  (max-width: 767px) {
	    .subhead.subhead-popup {
		margin-right: 40px;
		margin-left: 40px;
		text-align: center;
	    }
	    .subhead.subhead-popup.w-hidden-main.w-hidden-medium {
		font-size: 16px;
	    }
	}
    ...
    <div class="popup mfp-hide" data-mfp-src="#gamesForm">
	<form id="gamesForm" name="qprecord" class="registerForTheGame gamesForm" action="/ajax/save-record" data-name="Email Form">
    
	    <div class="popup-flex">
		<div data-w-id="a8571374-1d0c-4462-cfd6-57ce814e8726" class="close-popup"></div>
		<div class="window-popup">
		    <div class="top-window">
			<div class="subhead subhead-popup">
			    Здорово, что вы решили к  нам присоединиться.                        <br>
			    <span class="subhead-text-offline">Уже готовим столик для вашей команды!</span>
			    <span class="subhead-text-online">Пора запасаться вкусняшками для [стрима]!</span>
			</div>
			<div class="top-window__timer">
			    <p id="reservation-p" style="display: none;font-size: 14px;">
				<span id="reservation-status"></span>
				Открыта бронь, успейте подтвердить регистрацию за                            <span id="reservation-timer" style="color: #2ae2a4;"></span>
			    </p>
			</div>
		    </div>
		    <div class="popup-game-info">
			<div class="schedule-block-head mb-20" style="color: #333">
			    <div class="h2 schedule-block-title"></div>
			    <div class="h1 schedule-block-title-number"></div>
			</div>
			<div class="schedule-info text-cov" style="display:none;">
			    <div class="techtext">
								    <span class="text_cov">
					<span class="covid_free_general"></span>
					<a href="#text-popup-mod" class="span-green-link open-popup-link_mod" onclick="return initTextPopup('.open-popup-link_mod')">
					    Что это?
					</a>
				    </span>
			    </div>
			    <div id="text-popup-mod" class="white-popup mfp-hide" style="">
				<span class="covid_free_description"></span>
			    </div>
			</div>
			<div class="row w-row">
			    <div class="column w-col w-col-4" id="place-block">
				<div class="schedule-info popup-info">
				    <img src="/themes/b4/images/iconoteka_location__place_b_f.svg" alt="" class="schedule-icon trans">
				    <div>
					<div class="techtext schedule-block-info-bar"></div>
					<div class="techtext techtext-grey schedule-block-info-adress"></div>
				    </div>
				</div>
			    </div>
			    <div class="column w-col w-col-3">
				<div class="schedule-info popup-info">
				    <img src="/themes/b4/images/iconoteka_cash_b_f.svg" alt="" class="schedule-icon trans">
				    <div>
					<div class="techtext schedule-block-info-time"></div>
				    </div>
				</div>
			    </div>
			    <div class="column w-col w-col-5">
				<div class="schedule-info popup-info last">
				    <img width="26px" src="" alt="" class="schedule-icon trans schedule-block-info-payment-method">
				    <div>
					<div class="techtext schedule-block-info-price"></div>
					<div class="techtext techtext-grey js-sub-description__Game shedule-block-info-ages"></div>
				    </div>
				</div>
			    </div>
			</div>
		    </div>
		    <a href="#" title="Close (Esc)" type="button" data-w-id="a8571374-1d0c-4462-cfd6-57ce814e874c" class="mfp-close  close w-inline-block"></a>
		    <div class="red-alert text-warning" style="display: none;    margin-right: 0px;">
			<div class="p">Внимание, вы регистрируетесь в резерв! Вам нужно дождаться уведомления от&nbsp;нас,
			    что места появились и
			    можно приходить.
			</div>
		    </div>
		    <div id="p0" data-pjax-container="" data-pjax-push-state="" data-pjax-timeout="1000">
    
		    <ul id="w0" class="nav nav-tabs"><li class="active"><a href="#notplay" data-toggle="tab">Записаться на игру</a></li></ul>
    <div class="tab-content"><div id="notplay" class="tab-pane active">
    <style>
      .game-form-block{
	position: relative;
      }
	...
	display: none;
      ...
      .firstTimeBlock, .haveCertificate {
	display: block;
	margin: 30px 0;
		    width: 300px;
		    position: relative;
	...
	font: 700 18px Akrobat, Arial, Helvetica, sans-serif;
	    ...
	    input:checked + .checkbox-button {
		    background: #fdd835 5px no-repeat;
		    box-shadow: inset 0 0 0px 4px #f8f8f8;
		    border-radius: 3px;
      }
      input:checked + .firs-time_checkbox,
      input:checked + .have-certificate_checkbox {
		    box-shadow: inset 0 0 0px 4px #f8f8f8 !important;
      }
	    .checkbox-block {
	position: relative;
	padding-left: 35px;
	...
	margin: 5px;
      ...
      .custom_modal__btn:hover{
	background-color: #6937d2;
      }
    
      .wrapper__minMax_modal{
	display: none;
	position: absolute;
	top: 10px;
	right: -50px;
	...
	margin-bottom: 15px;
	  ...
	  .calculator-count:first-child {
	      padding-bottom: 11px;
	  }
	  .calculator-count:last-child {
	      padding-bottom: 8px;
	      opacity: 0.5;
	      border-bottom: 1px solid rgba(255,255,255,.5);
	      border-op
	  }
	  .calculator-count > div:last-child {
	      margin-left: 5px;
	  }
	  .inrease {
	      width: 320px;
	...
	.gray-block {
	    ...
	    .promo-code__button {
		    ...
		    background-color: #39E1A5;
		    outline: none;
		    font-family: Akrobat;
    
	    }
	    .promo-code__wrapper, .certificate__wrapper {
		    display: flex;
	    }
	    .response-msg, .certificate__response-msg {
	position: absolute;
	font-family: Raleway;
	font-style: normal;
	font-weight: 500;
	...
	.promo-code-cancell, .certificate-cancell {
	    cursor: pointer;
	}
	.response-msg__title_success, .certificate__response-msg__title_success {
	    font-family: Raleway;
	    font-style: normal;
	    font-weight: 600;
	    font-size: 16px;
	...
	.response-msg_success, .certificate__response-msg_success {
	    font-family: Raleway;
	    font-style: normal;
	    font-weight: 500;
	    font-size: 16px;
	...
	.check-label {
	    ...
	    width: 22px;
	    height: 22px;
	    border: 2px solid #6937D2 !important;
	}
    
	.check-input:checked + .check-label {
	    background: #6937D2 5px no-repeat !important;
	    box-shadow: inset 0 0 0px 4px #f8f8f8 !important;
	    border-radius: 3px;
	}
	...
	.add_certificate-field:focus, .add_certificate-field:hover, .add_certificate-field:active {
	  color: #fff;
	  outline: none;
	}
	...
	<div class="formcell">
		<div class="price-calculator">
			...
			<span id="total-price"></span> <span id="price-currency">₽ </span> <span id="pay-string"></span>
		    </div>
		</div>
	    </div>
	<div class="game-buttons w-clearfix">
	    <input type="button" value="Записаться на игру" id="form-button" class="button button-pink w-button form-button__js" data-function="">
	    <div class="warning w-clearfix">
	    <div class="warning-text grey">Нажимая на "Записаться на игру", вы соглашаетесь                <br>с <a id="modal-agreement" class="span-link" href="/agreement" target="_blank" onclick="window.open(&quot;/agreement&quot;, &quot;_blank&quot;); return false;">пользовательским соглашением</a>            </div>
	    </div>
	</div>
    ...
    <script>
      const btnCloseModal = document.querySelector('.minMax_modal__btn')
      const iconCloseModal = document.querySelector('.minMax_modal__close')
	...
	setTimeout(()=>{
      ...
      if(!!iconCloseModal){
	setTimeout(()=>{
	  iconCloseModal.addEventListener("click", closeCustomModal)
	}, 50)
      }
    
      function openCustomModale (e) {
	e.preventDefault()
	const modal = document.querySelector('.wrapper__minMax_modal')
	modal.classList.add('show')
	
	setTimeout(() => {
	  window.addEventListener('click', checkOutsideModal)
	}, 0);
      }
    
      function checkOutsideModal (event) {
	const checkElem = document.querySelector('.wrapper__minMax_modal.show')
	const { target } = event
	const matches = target.matches('.wrapper__minMax_modal') 
	  || target.matches('.wrapper__minMax_modal div')
	  || target.matches('.wrapper__minMax_modal p')
	  || target.matches('.wrapper__minMax_modal button')
	...
	const modal = document.querySelector('.wrapper__minMax_modal.show')
	modal.classList.remove('show')
	window.removeEventListener('click', checkOutsideModal)
      }
    </script></div></div>                </div>            </div>
	    </div></form>
    </div>
    <div class="mfp-hide" data-mfp-src="#notify">
	<div id="notify" class="tips-content"></div>
    </div>
    <div data-cityid="17" class="container container-header w-clearfix">
	<h1 class="h1 h1-nomargin h1-center">Расписание игр</h1>
    
		<a href="schedule-past" class="header-link w-inline-block" onclick="yaCounter35711540.reachGoal('ClickPastGames');ga('send', 'event', 'ClickPastGames', 'click');">
		<img src="themes/b4/images/archive-white.svg" alt="" class="header-link-icon w-hidden-small w-hidden-tiny">
		<div class="w-fontSize-small">Прошедшие игры</div>
		<img src="themes/b4/images/chevron-right.png" alt="" class="header-link-icon header-link-arrow w-hidden-medium w-hidden-main">
	    </a>
	</div>
    </main>
    ...
    <div class="section">
		...
		<div class="column w-col w-col-3 w-col-stack">
		    <div class="schedule-filter-block w-form">
			<a href="#" class="schedule-filter-open w-inline-block" data-ix="open-filter-m">
			    <img src="/themes/b4/images/filter-white.svg" alt="" class="filter-open-icon">
			    <div>Фильтр игр</div>
			</a>
			<form id="filters" action="schedule" method="get" data-pjax="1" data-name="Email Form" class="scheduleLeft-filter filter-block-drop schedule-filter-form"><button data-ix="close-filter-m" type="submit" class="close-schedule-filter w-inline-block"><div>Закрыть фильтр</div></button> <div class="schedule-filter-window"><div class="schedule-filter"><div class="w-embed"></div> <div class="filter-selectblock"><div class="form-group field-qpgamesearch-cityid"><select id="qpgamesearch-cityid" name="QpGameSearch[cityId]" class="filter-select w-select" style="background-image: url(&quot;../themes/b4/images/drop-white.svg&quot;); background-position: right center; background-repeat: no-repeat no-repeat;"><option value="151">Абакан</option> <option value="130">Актау</option> <option value="116">Актобе</option> <option value="164">Аланья</option> <option value="49">Алматы</option> <option value="70">Альметьевск</option> <option value="152">Анадырь</option> <option value="155">Ансан</option> <option value="153">Анталья</option> <option value="35">Астана</option> <option value="106">Атырау</option> <option value="167">Баку</option> <option value="90">Балаково</option> <option value="165">Бали</option> <option value="31">Барнаул</option> <option value="142">Батуми</option> <option value="132">Берлин</option> <option value="44">Беэр-Шева</option> <option value="134">Бишкек</option> <option value="40">Благовещенск</option> <option value="60">Бостон</option> <option value="56">Брест</option> <option value="148">Брянск</option> <option value="157">Будва</option> <option value="149">Великий Новгород</option> <option value="5">Владивосток</option> <option value="120">Владикавказ</option> <option value="36">Владимир</option> <option value="93">Волгоград</option> <option value="57">Волгодонск</option> <option value="94">Волжский</option> <option value="144">Вологда</option> <option value="67">Воронеж</option> <option value="52">Воткинск</option> <option value="107">Горно-Алтайск</option> <option value="13">Екатеринбург</option> <option value="147">Ереван</option> <option value="128">Ессентуки</option> <option value="81">Иерусалим</option> <option value="51">Ижевск</option> <option value="156">Инчхон</option> <option value="62">Иркутск</option> <option value="53">Йошкар-Ола</option> <option value="21">Казань</option> <option value="92">Калининград</option> <option value="38">Калуга</option> <option value="86">Караганда</option> <option value="33">Кемерово</option> <option value="114">Киров</option> <option value="131">Комсомольск-на-Амуре</option> <option value="37">Краснодар</option> <option value="41">Красноярск</option> <option value="73">Лимассол</option> <option value="80">Липецк</option> <option value="42">Лондон</option> <option value="20">Магадан</option> <option value="145">Майами</option> <option value="163">Мерсин</option> <option value="74">Минск</option> <option value="136">Монреаль</option> <option value="9">Москва</option> <option value="16">Набережные Челны</option> <option value="46">Находка</option> <option value="59">Нефтекамск</option> <option value="162">Нижневартовск</option> <option value="54">Нижнекамск</option> <option value="15">Нижний Новгород</option> <option value="99">Новокузнецк</option> <option value="138">Новороссийск</option> <option value="10">Новосибирск</option> <option value="98">Новый Уренгой</option> <option value="158">Ноябрьск</option> <option value="26">Нью-Йорк</option> <option value="50">Обнинск</option> <option value="78">Октябрьский</option> <option value="84">Омск</option> <option value="111">Оренбург</option> <option value="97">Павлодар</option> <option value="108">Пекин</option> <option value="91">Пенза</option> <option value="43">Пермь</option> <option value="83">Петрозаводск</option> <option value="34">Петропавловск-Камчатский</option> <option value="29">Псков</option> <option value="166">Пхукет</option> <option value="118">Пятигорск</option> <option value="58">Рига</option> <option value="19">Ростов-на-Дону</option> <option value="23">Самара</option> <option value="17" selected="selected">Санкт-Петербург</option> <option value="150">Саранск</option> <option value="141">Сарапул</option> <option value="63">Саратов</option> <option value="140">Свободный</option> <option value="69">Севастополь</option> <option value="96">Семей</option> <option value="154">Сеул</option> <option value="133">Симферополь</option> <option value="68">Сочи</option> <option value="25">Ставрополь</option> <option value="159">Стамбул</option> <option value="22">Стерлитамак</option> <option value="77">Сыктывкар</option> <option value="28">Таганрог</option> <option value="71">Тамбов</option> <option value="146">Тараз</option> <option value="89">Ташкент</option> <option value="160">Тбилиси</option> <option value="32">Тель-Авив</option> <option value="129">Темиртау</option> <option value="110">Тольятти</option> <option value="85">Томск</option> <option value="55">Торонто</option> <option value="100">Тула</option> <option value="24">Тюмень</option> <option value="135">Уральск</option> <option value="18">Уссурийск</option> <option value="87">Усть-Каменогорск</option> <option value="6">Уфа</option> <option value="103">Ухта</option> <option value="39">Филадельфия</option> <option value="4">Хабаровск</option> <option value="66">Хайфа</option> <option value="14">Чебоксары</option> <option value="12">Челябинск</option> <option value="113">Чита</option> <option value="122">Шанхай</option> <option value="79">Шахты</option> <option value="123">Шымкент</option> <option value="64">Энгельс</option> <option value="30">Южно-Сахалинск</option> <option value="76">Ярославль</option></select> <div class="help-block"></div></div></div> <div class="form-group field-qpgamesearch-dates"><input type="hidden" id="qpgamesearch-dates" name="QpGameSearch[dates]" class="form-control"> <div class="help-block"></div></div> <div class="filter-selectblock last"><button type="button" class="filter-button"><span>Календарь игр</span> <span class=""><img src="../themes/b4/images/drop-white.svg" alt="arrow"></span></button></div></div> <div class="schedule-filter calendar" style="display: none;"><div id="calendarBlock"><div class="air-datepicker -inline-"><i class="air-datepicker--pointer"></i><div class="air-datepicker--navigation"><nav class="air-datepicker-nav"><div class="air-datepicker-nav--action -disabled-" data-action="prev"><svg><path d="M 17,12 l -5,5 l 5,5"></path></svg></div><div class="air-datepicker-nav--title">Январь 2023</div><div class="air-datepicker-nav--action -disabled-" data-action="next"><svg><path d="M 14,12 l 5,5 l -5,5"></path></svg></div></nav></div><div class="air-datepicker--content"><div class="air-datepicker-body -days-"><div class="air-datepicker-body--day-names"><div class="air-datepicker-body--day-name">Пн</div><div class="air-datepicker-body--day-name">Вт</div><div class="air-datepicker-body--day-name">Ср</div><div class="air-datepicker-body--day-name">Чт</div><div class="air-datepicker-body--day-name">Пт</div><div class="air-datepicker-body--day-name -weekend-">Сб</div><div class="air-datepicker-body--day-name -weekend-">Вс</div></div><div class="air-datepicker-body--cells -days-"><div class="air-datepicker-cell -day- -other-month- -disabled-" data-year="2022" data-month="11" data-date="26">26</div><div class="air-datepicker-cell -day- -other-month- -disabled-" data-year="2022" data-month="11" data-date="27">27</div><div class="air-datepicker-cell -day- -other-month- -disabled-" data-year="2022" data-month="11" data-date="28">28</div><div class="air-datepicker-cell -day- -other-month- -disabled-" data-year="2022" data-month="11" data-date="29">29</div><div class="air-datepicker-cell -day- -other-month- -disabled-" data-year="2022" data-month="11" data-date="30">30</div><div class="air-datepicker-cell -day- -weekend- -other-month- -disabled-" data-year="2022" data-month="11" data-date="31">31</div><div class="air-datepicker-cell -day- -weekend- -disabled-" data-year="2023" data-month="0" data-date="1">1</div><div class="air-datepicker-cell -day- -disabled-" data-year="2023" data-month="0" data-date="2">2</div><div class="air-datepicker-cell -day- -disabled-" data-year="2023" data-month="0" data-date="3">3</div><div class="air-datepicker-cell -day- -disabled-" data-year="2023" data-month="0" data-date="4">4</div><div class="air-datepicker-cell -day- -disabled-" data-year="2023" data-month="0" data-date="5">5</div><div class="air-datepicker-cell -day- -disabled-" data-year="2023" data-month="0" data-date="6">6</div><div class="air-datepicker-cell -day- -weekend- -disabled-" data-year="2023" data-month="0" data-date="7">7</div><div class="air-datepicker-cell -day- -weekend- -disabled-" data-year="2023" data-month="0" data-date="8">8</div><div class="air-datepicker-cell -day- -disabled-" data-year="2023" data-month="0" data-date="9">9</div><div class="air-datepicker-cell -day- -disabled-" data-year="2023" data-month="0" data-date="10">10</div><div class="air-datepicker-cell -day- -disabled-" data-year="2023" data-month="0" data-date="11">11</div><div class="air-datepicker-cell -day- -disabled-" data-year="2023" data-month="0" data-date="12">12</div><div class="air-datepicker-cell -day- -disabled-" data-year="2023" data-month="0" data-date="13">13</div><div class="air-datepicker-cell -day- -weekend- -disabled-" data-year="2023" data-month="0" data-date="14">14</div><div class="air-datepicker-cell -day- -weekend- -disabled-" data-year="2023" data-month="0" data-date="15">15</div><div class="air-datepicker-cell -day- -disabled-" data-year="2023" data-month="0" data-date="16">16</div><div class="air-datepicker-cell -day- -current- -min-date- enable-cell" data-year="2023" data-month="0" data-date="17">17</div><div class="air-datepicker-cell -day- enable-cell" data-year="2023" data-month="0" data-date="18">18</div><div class="air-datepicker-cell -day- enable-cell" data-year="2023" data-month="0" data-date="19">19</div><div class="air-datepicker-cell -day- enable-cell" data-year="2023" data-month="0" data-date="20">20</div><div class="air-datepicker-cell -day- -weekend- enable-cell" data-year="2023" data-month="0" data-date="21">21</div><div class="air-datepicker-cell -day- -weekend- enable-cell" data-year="2023" data-month="0" data-date="22">22</div><div class="air-datepicker-cell -day- -disabled-" data-year="2023" data-month="0" data-date="23">23</div><div class="air-datepicker-cell -day- enable-cell" data-year="2023" data-month="0" data-date="24">24</div><div class="air-datepicker-cell -day- enable-cell" data-year="2023" data-month="0" data-date="25">25</div><div class="air-datepicker-cell -day- enable-cell" data-year="2023" data-month="0" data-date="26">26</div><div class="air-datepicker-cell -day- enable-cell" data-year="2023" data-month="0" data-date="27">27</div><div class="air-datepicker-cell -day- -weekend- enable-cell" data-year="2023" data-month="0" data-date="28">28</div><div class="air-datepicker-cell -day- -max-date- -weekend- enable-cell" data-year="2023" data-month="0" data-date="29">29</div><div class="air-datepicker-cell -day- -disabled-" data-year="2023" data-month="0" data-date="30">30</div><div class="air-datepicker-cell -day- -disabled-" data-year="2023" data-month="0" data-date="31">31</div><div class="air-datepicker-cell -day- -other-month- -disabled-" data-year="2023" data-month="1" data-date="1">1</div><div class="air-datepicker-cell -day- -other-month- -disabled-" data-year="2023" data-month="1" data-date="2">2</div><div class="air-datepicker-cell -day- -other-month- -disabled-" data-year="2023" data-month="1" data-date="3">3</div><div class="air-datepicker-cell -day- -weekend- -other-month- -disabled-" data-year="2023" data-month="1" data-date="4">4</div><div class="air-datepicker-cell -day- -weekend- -other-month- -disabled-" data-year="2023" data-month="1" data-date="5">5</div></div></div></div><div class="air-datepicker--buttons"><div class="air-datepicker-buttons"><span class="air-datepicker-button"><span tabindex="-1">Очистить</span></span><button class="air-datepicker-button"><span tabindex="-1">Применить</span></button></div></div></div></div></div> <div class="schedule-filter"><div class="filter-radios"><div id="all-value-seats" class="seats"><div class="filter-radio"><label class="checkbox-block"><input type="checkbox" value="all" name="QpGameSearch[status][]" checked="checked"> <span class=" image-4 checkbox-button checkbox-button-active"></span>Все игры
									    </label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" value="1" name="QpGameSearch[status][]"> <span class=" image-4 checkbox-button "></span>Есть места
									    </label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" value="2" name="QpGameSearch[status][]"> <span class=" image-4 checkbox-button "></span>Запись в резерв
									    </label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" value="3" name="QpGameSearch[status][]"> <span class=" image-4 checkbox-button "></span>Нет мест
									    </label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" value="6" name="QpGameSearch[status][]"> <span class=" image-4 checkbox-button "></span>Оконченная
									    </label></div></div></div></div> <div class="schedule-filter"><div class="filter-radios"><div id="all-value-bars" class="bars"><div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[format][]" value="all" checked="checked"> <span class="image-4 checkbox-button checkbox-button-active "></span>
																    Все форматы
																    </label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[format][]" value="0"> <span class="image-4 checkbox-button  "></span>
																    Офлайн
																    </label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[format][]" value="1"> <span class="image-4 checkbox-button  "></span>
																    Онлайн
																    </label></div></div></div></div> <div class="schedule-filter"><div class="filter-radios"><div id="all-value-bars" class="bars"><div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[type][]" value="all" checked="checked"> <span class="image-4 checkbox-button checkbox-button-active "></span>
																    Все типы
																    </label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[type][]" value="1"> <span class="image-4 checkbox-button  "></span> <div class="techtext">Классические игры </div></label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[type][]" value="3"> <span class="image-4 checkbox-button  "></span> <div class="techtext">Игры для подростков	</div></label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[type][]" value="5"> <span class="image-4 checkbox-button  "></span> <div class="techtext">Кино-музыкальные игры	</div></label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[type][]" value="2"> <span class="image-4 checkbox-button  "></span> <div class="techtext">Тематические игры </div></label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[type][]" value="9"> <span class="image-4 checkbox-button  "></span> <div class="techtext">Тематические кино-музыкальные игры</div></label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[type][]" value="-2"> <span class="image-4 checkbox-button  "></span> <div class="techtext">Игры для новичков</div></label></div></div></div></div> <div class="schedule-filter last"><div class="filter-radios"><div id="all-value-bars" class="bars"><div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[bars][]" value="all" checked="checked"> <span class="image-4 checkbox-button checkbox-button-active "></span>
																    Все бары
																    </label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[bars][]" value="29"> <span class="image-4 checkbox-button  "></span> <div class="techtext">Grand Bianco</div> <div class="techtext techtext-halfwhite">Набережная канала Грибоедова, д. 36</div></label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[bars][]" value="40"> <span class="image-4 checkbox-button  "></span> <div class="techtext">Ресторан ParkKing</div> <div class="techtext techtext-halfwhite">Александровский парк, д.4</div></label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[bars][]" value="635"> <span class="image-4 checkbox-button  "></span> <div class="techtext">ЦИНЬ</div> <div class="techtext techtext-halfwhite">16 линия В.О дом 83</div></label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[bars][]" value="796"> <span class="image-4 checkbox-button  "></span> <div class="techtext">Rossi's Club</div> <div class="techtext techtext-halfwhite">ул. Зодчего Росси 1/3</div></label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[bars][]" value="881"> <span class="image-4 checkbox-button  "></span> <div class="techtext">Puberty</div> <div class="techtext techtext-halfwhite">наб. Выборгская, д.47</div></label></div> <div class="filter-radio"><label class="checkbox-block"><input type="checkbox" name="QpGameSearch[bars][]" value="952"> <span class="image-4 checkbox-button  "></span> <div class="techtext">Дворец Олимпия</div> <div class="techtext techtext-halfwhite">Литейный пр., д. 14</div></label></div></div></div></div></div></form>                    <div class="w-form-done">
		...
		<div class="column w-col w-col-9 w-col-stack">
		    <!-- The Modal -->
				...
				<a href="https://clck.ru/33HKQq" onclick="yaCounter35711540.reachGoal('ClickBannerPromoGame');ga('send', 'event', 'ClickBannerPromoGame', 'click');">
				    <picture>
					<source media="(min-width: 1200px)" srcset="/storage/source/1/pfW7VY3hLLvpm9-0SQkBXvi65g5KFi7_.png">
					<source media="(min-width: 900px)" srcset="/storage/source/1/pfW7VY3hLLvpm9-0SQkBXvi65g5KFi7_.png">
					<source media="(min-width: 480px)" srcset="/storage/source/1/pfW7VY3hLLvpm9-0SQkBXvi65g5KFi7_.png">
					<source media="(min-width: 240px)" srcset="/storage/source/1/pfW7VY3hLLvpm9-0SQkBXvi65g5KFi7_.png">
					<img src="" class="img-responsive">
				    </picture>
				</a>
			    </div>
			
		    <div class="schedule-row schedule-row-fix w-clearfix">
			<div class="schedule-row schedule-row-fix schedule-world-cup"></div>
		    </div>
    
		    <div id="schedule-vue" class="schedule-row schedule-row-fix w-clearfix"><div id="w1" class="schedule-row schedule-row-fix"><div id="50482" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="schedule-days-left"><span class="schedule-days-left-text">Игра сегодня. Еще успеваете!</span></div> <div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    17 января, Вторник			</div> <div class="schedule-block-top"><a href="/game-page?id=50482" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card ">#610</div></a> <div class="techtext techtext-mb30">Во вторник может случиться все, что угодно! Вы даже можете выиграть в интеллектуальной игре, где вас ждут множество интересных вопросов на самые разные темы, обаятельный ведущий, толпа соперников, настоящий дух битвы и призы, конечно.				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Grand Bianco																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Набережная канала Грибоедова, д. 36										<a href="#" onclick="initMap(50482);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50482, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50482" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50483" class="schedule-column"><div class="schedule-block end" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-yellow h3-mb10 block-date-with-language-game game-end">
				    17 января, Вторник			</div> <div class="schedule-block-top"><a href="/game-page?id=50483" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card">#611</div></a> <div class="techtext techtext-mb30">Не надо ждать выходных, чтобы как следует повеселиться! Квиз, плиз! работает семь дней в неделю. У нас есть мешок крутых мозгодробительных вопросов, классный бар, толпа людей, среди которых можете быть вы со своей командой.				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Puberty                                    									<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">наб. Выборгская, д.47									<a href="#" onclick="initMap(50483);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom w-clearfix"><div class="game-status schedule-end w-clearfix"><img src="/themes/b4/images/stop-white.svg" alt="" class="game-status-icon"> <div>Нет мест! Но можно записаться в резерв</div></div> <div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50483, true, false, this);" data-ix="open-popup" class="button button-yellow button-left button-small w-button" style="transition: all 0.1s ease 0s;">Записаться в резерв</a> <a href="/game-page?id=50483" onclick="callAnalytics(null, null, ['track', 'InitiateCheckout'], 'initiate_checkout');sendFBAnalyticsMetric('ViewContent');" class="button button-yellow button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50484" class="schedule-column"><div class="schedule-block end" style="background-image: url(&quot;/files/2019/07/5d31b6c8ac7ad.png&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-yellow h3-mb10 block-date-with-language-game game-end">
				    18 января, Среда			</div> <div class="schedule-block-top"><a href="/game-page?id=50484" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">[18+] SPB</div> <div class="h2 h2-game-card">#6</div></a> <div class="techtext techtext-mb30">Тематическая игра 18+ для тех, кто не стесняется.				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Grand Bianco                                    									<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Набережная канала Грибоедова, д. 36									<a href="#" onclick="initMap(50484);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom w-clearfix"><div class="game-status schedule-end w-clearfix"><img src="/themes/b4/images/stop-white.svg" alt="" class="game-status-icon"> <div>Нет мест! Но можно записаться в резерв</div></div> <div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50484, true, false, this);" data-ix="open-popup" class="button button-yellow button-left button-small w-button" style="transition: all 0.1s ease 0s;">Записаться в резерв</a> <a href="/game-page?id=50484" onclick="callAnalytics(null, null, ['track', 'InitiateCheckout'], 'initiate_checkout');sendFBAnalyticsMetric('ViewContent');" class="button button-yellow button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50485" class="schedule-column"><div class="schedule-block end" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-yellow h3-mb10 block-date-with-language-game game-end">
				    18 января, Среда			</div> <div class="schedule-block-top"><a href="/game-page?id=50485" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card">#610</div></a> <div class="techtext techtext-mb30">Середина недели - самое время начать веселиться, если вы еще не. Мы вот да. Поэтому сегодня соберем толпу самых умных в [таком-то] баре, а самые умные будут запивать свой вкусный ужин чем-то горячительным, отвечая на наши каверзные вопросы.				</div> <div class="schedule-info-block"><div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Ресторан ParkKing                                    									<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Александровский парк, д.4									<a href="#" onclick="initMap(50485);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные</div></div></div></div></div></div></div> <div class="schedule-block-bottom w-clearfix"><div class="game-status schedule-end w-clearfix"><img src="/themes/b4/images/stop-white.svg" alt="" class="game-status-icon"> <div>Нет мест! Но можно записаться в резерв</div></div> <div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50485, true, false, this);" data-ix="open-popup" class="button button-yellow button-left button-small w-button" style="transition: all 0.1s ease 0s;">Записаться в резерв</a> <a href="/game-page?id=50485" onclick="callAnalytics(null, null, ['track', 'InitiateCheckout'], 'initiate_checkout');sendFBAnalyticsMetric('ViewContent');" class="button button-yellow button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50486" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;/files/2022%2F02%2F61f933d21156e.png&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="schedule-days-left"><span class="schedule-days-left-text">До игры осталось 2 дня</span></div> <div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    19 января, Четверг			</div> <div class="schedule-block-top"><a href="/game-page?id=50486" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">[назад в 2010-е] SPB</div> <div class="h2 h2-game-card ">#2</div></a> <div class="techtext techtext-mb30">Еще не история, но уже не современность. Речь не про спинеры, но время, подарившее нам столько всего (включая спинеры!) – 2010-е!				</div> <div class="schedule-info-block"><div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">ЦИНЬ																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">16 линия В.О дом 83										<a href="#" onclick="initMap(50486);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50486, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50486" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50487" class="schedule-column"><div class="schedule-block end" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-yellow h3-mb10 block-date-with-language-game game-end">
				    19 января, Четверг			</div> <div class="schedule-block-top"><a href="/game-page?id=50487" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card">#611</div></a> <div class="techtext techtext-mb30">Грамотный кутеж начинается с аперитива и с Квиз, плиз! Классическая игра с традиционно крутыми вопросами, хорошенько поужинать и пригубить горячительного — то, что нужно.				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Grand Bianco                                    									<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Набережная канала Грибоедова, д. 36									<a href="#" onclick="initMap(50487);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom w-clearfix"><div class="game-status schedule-end w-clearfix"><img src="/themes/b4/images/stop-white.svg" alt="" class="game-status-icon"> <div>Нет мест! Но можно записаться в резерв</div></div> <div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50487, true, false, this);" data-ix="open-popup" class="button button-yellow button-left button-small w-button" style="transition: all 0.1s ease 0s;">Записаться в резерв</a> <a href="/game-page?id=50487" onclick="callAnalytics(null, null, ['track', 'InitiateCheckout'], 'initiate_checkout');sendFBAnalyticsMetric('ViewContent');" class="button button-yellow button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50488" class="schedule-column"><div class="schedule-block closed" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-pink h3-mb10 block-date-with-language-game game-closed">
				    20 января, Пятница        	</div> <div class="schedule-block-top"><a href="/game-page?id=50488" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">[music party] кринж эдишн SPB</div> <div class="h2 h2-game-card ">#1</div></a> <div class="techtext techtext-mb30">Хотели на Грэмми, а попали на премию МУЗ-ТВ.				</div> <div class="schedule-info-block"><div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Ресторан ParkKing                                    									<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Александровский парк, д.4									<a href="#" onclick="initMap(50488);" class="span-green-link">
										    Где это?									</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные</div></div></div></div></div></div></div> <div class="schedule-block-bottom w-clearfix"><div class="game-status schedule-end w-clearfix"><img src="/themes/b4/images/lock-black_1.svg" alt="" class="game-status-icon"> <div>Нет мест! Резерв заполнен</div></div> <div class="game-buttons available"><a href="/game-page?id=50488" onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" class="button button-pink button-left button-small w-button">Регистрация закрыта</a> <a href="/game-page?id=50488" onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" class="button button-pink button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50490" class="schedule-column"><div class="schedule-block closed" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-pink h3-mb10 block-date-with-language-game game-closed">
				    20 января, Пятница        	</div> <div class="schedule-block-top"><a href="/game-page?id=50490" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card ">#612</div></a> <div class="techtext techtext-mb30">Пятница, Квиз, плиз!, Rossi's Club — составляющие хорошего настроения. Можно задом наперед или в другом порядке. Подходит для всех людей от 15 до 99. Легально.				</div> <div class="schedule-info-block"><div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Rossi's Club                                    									<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">ул. Зодчего Росси 1/3									<a href="#" onclick="initMap(50490);" class="span-green-link">
										    Где это?									</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные</div></div></div></div></div></div></div> <div class="schedule-block-bottom w-clearfix"><div class="game-status schedule-end w-clearfix"><img src="/themes/b4/images/lock-black_1.svg" alt="" class="game-status-icon"> <div>Нет мест! Резерв заполнен</div></div> <div class="game-buttons available"><a href="/game-page?id=50490" onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" class="button button-pink button-left button-small w-button">Регистрация закрыта</a> <a href="/game-page?id=50490" onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" class="button button-pink button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50852" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;/files/2020/03/5e72700f700b8.png&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="schedule-days-left"><span class="schedule-days-left-text">До игры осталось 3 дня</span></div> <div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    20 января, Пятница			</div> <div class="schedule-block-top"><a href="/game-page?id=50852" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! [стрим] SPB</div> <div class="h2 h2-game-card ">#296</div></a> <div class="techtext techtext-mb30">Позаботьтесь о стабильном интернете, протрите клавиатуру влажными салфетками, приготовьтесь печатать разборчиво — это Квиз, плиз! [стрим]. И не вздумайте гуглить — мы вас по айпи вычислим!				</div> <div class="schedule-info-block"><div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Везде, где есть интернет																			</div></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 20:00</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">1000₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с команды</div> <div>оплата онлайн</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50852, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50852" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50491" class="schedule-column"><div class="schedule-block closed" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-pink h3-mb10 block-date-with-language-game game-closed">
				    21 января, Суббота        	</div> <div class="schedule-block-top"><a href="/game-page?id=50491" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Кино и музыка [новички] SPB</div> <div class="h2 h2-game-card ">#103</div></a> <div class="techtext techtext-mb30">Вы молодые и подающие надежды исполнители? Тогда довольно исполнять, пока никто не видит и не слышит! Специально для вас мы запускаем кино-музыкальные игры для новичков.				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Grand Bianco                                    									<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Набережная канала Грибоедова, д. 36									<a href="#" onclick="initMap(50491);" class="span-green-link">
										    Где это?									</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 15:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom w-clearfix"><div class="game-status schedule-end w-clearfix"><img src="/themes/b4/images/lock-black_1.svg" alt="" class="game-status-icon"> <div>Нет мест! Резерв заполнен</div></div> <div class="game-buttons available"><a href="/game-page?id=50491" onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" class="button button-pink button-left button-small w-button">Регистрация закрыта</a> <a href="/game-page?id=50491" onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" class="button button-pink button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50492" class="schedule-column"><div class="schedule-block end" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-yellow h3-mb10 block-date-with-language-game game-end">
				    21 января, Суббота			</div> <div class="schedule-block-top"><a href="/game-page?id=50492" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз!.jpeg SPB</div> <div class="h2 h2-game-card">#1</div></a> <div class="techtext techtext-mb30">Игра для тех, кто угадает, что мы зашифровали на картинке.				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Puberty                                    									<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">наб. Выборгская, д.47									<a href="#" onclick="initMap(50492);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 16:00</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom w-clearfix"><div class="game-status schedule-end w-clearfix"><img src="/themes/b4/images/stop-white.svg" alt="" class="game-status-icon"> <div>Нет мест! Но можно записаться в резерв</div></div> <div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50492, true, false, this);" data-ix="open-popup" class="button button-yellow button-left button-small w-button" style="transition: all 0.1s ease 0s;">Записаться в резерв</a> <a href="/game-page?id=50492" onclick="callAnalytics(null, null, ['track', 'InitiateCheckout'], 'initiate_checkout');sendFBAnalyticsMetric('ViewContent');" class="button button-yellow button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50494" class="schedule-column"><div class="schedule-block end" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-yellow h3-mb10 block-date-with-language-game game-end">
				    21 января, Суббота			</div> <div class="schedule-block-top"><a href="/game-page?id=50494" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card">#610</div></a> <div class="techtext techtext-mb30">Играем вопросы #610 в субботу во Дворце Олимпия. План следующий: собираем всех умниц под одной крышей, выясняем, кто самый умный. В программе вечера также крутые вопросы, классный ведущий, призы, подарки, шоу, восторг.				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Дворец Олимпия                                    									<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Литейный пр., д. 14									<a href="#" onclick="initMap(50494);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom w-clearfix"><div class="game-status schedule-end w-clearfix"><img src="/themes/b4/images/stop-white.svg" alt="" class="game-status-icon"> <div>Нет мест! Но можно записаться в резерв</div></div> <div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50494, true, false, this);" data-ix="open-popup" class="button button-yellow button-left button-small w-button" style="transition: all 0.1s ease 0s;">Записаться в резерв</a> <a href="/game-page?id=50494" onclick="callAnalytics(null, null, ['track', 'InitiateCheckout'], 'initiate_checkout');sendFBAnalyticsMetric('ViewContent');" class="button button-yellow button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50493" class="schedule-column"><div class="schedule-block end" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-yellow h3-mb10 block-date-with-language-game game-end">
				    21 января, Суббота			</div> <div class="schedule-block-top"><a href="/game-page?id=50493" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card">#611</div></a> <div class="techtext techtext-mb30">Выходные для души, а не для мозгов - помогаем держать в тонусе серое вещество даже в субботу. В базовой комплектации также идут вкусная еда, доступ к алкоголю, любимые друзья и атмосфера праздника.				</div> <div class="schedule-info-block"><div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Ресторан ParkKing                                    									<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Александровский парк, д.4									<a href="#" onclick="initMap(50493);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные</div></div></div></div></div></div></div> <div class="schedule-block-bottom w-clearfix"><div class="game-status schedule-end w-clearfix"><img src="/themes/b4/images/stop-white.svg" alt="" class="game-status-icon"> <div>Нет мест! Но можно записаться в резерв</div></div> <div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50493, true, false, this);" data-ix="open-popup" class="button button-yellow button-left button-small w-button" style="transition: all 0.1s ease 0s;">Записаться в резерв</a> <a href="/game-page?id=50493" onclick="callAnalytics(null, null, ['track', 'InitiateCheckout'], 'initiate_checkout');sendFBAnalyticsMetric('ViewContent');" class="button button-yellow button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50853" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;/files/2020/03/5e72700f700b8.png&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    21 января, Суббота			</div> <div class="schedule-block-top"><a href="/game-page?id=50853" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! [стрим] SPB</div> <div class="h2 h2-game-card ">#297</div></a> <div class="techtext techtext-mb30">Позаботьтесь о стабильном интернете, протрите клавиатуру влажными салфетками, приготовьтесь печатать разборчиво — это Квиз, плиз! [стрим]. И не вздумайте гуглить — мы вас по айпи вычислим!				</div> <div class="schedule-info-block"><div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Везде, где есть интернет																			</div></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 20:00</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">1000₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с команды</div> <div>оплата онлайн</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50853, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50853" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50495" class="schedule-column"><div class="schedule-block end" style="background-image: url(&quot;/files/media_old/qp_files_30.png&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-yellow h3-mb10 block-date-with-language-game game-end">
				    22 января, Воскресенье			</div> <div class="schedule-block-top"><a href="/game-page?id=50495" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">[кино и музыка] SPB</div> <div class="h2 h2-game-card">#103</div></a> <div class="techtext techtext-mb30">2 часа интеллектуальной дискотеки: вопросы только про кино и музыку. Единственное место, где русский рэп может встретиться с Шопеном, а победят не самые умные, а те, кто больше сериалов посмотрел.				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Grand Bianco                                    									<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Набережная канала Грибоедова, д. 36									<a href="#" onclick="initMap(50495);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 15:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom w-clearfix"><div class="game-status schedule-end w-clearfix"><img src="/themes/b4/images/stop-white.svg" alt="" class="game-status-icon"> <div>Нет мест! Но можно записаться в резерв</div></div> <div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50495, true, false, this);" data-ix="open-popup" class="button button-yellow button-left button-small w-button" style="transition: all 0.1s ease 0s;">Записаться в резерв</a> <a href="/game-page?id=50495" onclick="callAnalytics(null, null, ['track', 'InitiateCheckout'], 'initiate_checkout');sendFBAnalyticsMetric('ViewContent');" class="button button-yellow button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50496" class="schedule-column"><div class="schedule-block end" style="background-image: url(&quot;/files/2019/06/5d15e12361a07.png&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-yellow h3-mb10 block-date-with-language-game game-end">
				    22 января, Воскресенье			</div> <div class="schedule-block-top"><a href="/game-page?id=50496" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">[назад в СССР] SPB</div> <div class="h2 h2-game-card">#5</div></a> <div class="techtext techtext-mb30">Игра для всех, кто скучает по СССР. Здесь будут фильмы, музыка и реалии Советского Союза. Газировка с сиропом, возможно, тоже.				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Puberty                                    									<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">наб. Выборгская, д.47									<a href="#" onclick="initMap(50496);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 16:00</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom w-clearfix"><div class="game-status schedule-end w-clearfix"><img src="/themes/b4/images/stop-white.svg" alt="" class="game-status-icon"> <div>Нет мест! Но можно записаться в резерв</div></div> <div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50496, true, false, this);" data-ix="open-popup" class="button button-yellow button-left button-small w-button" style="transition: all 0.1s ease 0s;">Записаться в резерв</a> <a href="/game-page?id=50496" onclick="callAnalytics(null, null, ['track', 'InitiateCheckout'], 'initiate_checkout');sendFBAnalyticsMetric('ViewContent');" class="button button-yellow button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50497" class="schedule-column"><div class="schedule-block end" style="background-image: url(&quot;/files/2022%2F02%2F61f933d21156e.png&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-yellow h3-mb10 block-date-with-language-game game-end">
				    22 января, Воскресенье			</div> <div class="schedule-block-top"><a href="/game-page?id=50497" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">[назад в 2010-е] SPB</div> <div class="h2 h2-game-card">#2</div></a> <div class="techtext techtext-mb30">Еще не история, но уже не современность. Речь не про спинеры, но время, подарившее нам столько всего (включая спинеры!) – 2010-е!				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Grand Bianco                                    									<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Набережная канала Грибоедова, д. 36									<a href="#" onclick="initMap(50497);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom w-clearfix"><div class="game-status schedule-end w-clearfix"><img src="/themes/b4/images/stop-white.svg" alt="" class="game-status-icon"> <div>Нет мест! Но можно записаться в резерв</div></div> <div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50497, true, false, this);" data-ix="open-popup" class="button button-yellow button-left button-small w-button" style="transition: all 0.1s ease 0s;">Записаться в резерв</a> <a href="/game-page?id=50497" onclick="callAnalytics(null, null, ['track', 'InitiateCheckout'], 'initiate_checkout');sendFBAnalyticsMetric('ViewContent');" class="button button-yellow button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50498" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    22 января, Воскресенье			</div> <div class="schedule-block-top"><a href="/game-page?id=50498" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card ">#612</div></a> <div class="techtext techtext-mb30">Воскресная битва для тех, кто не знает устали. Чтоб с настроением зайти в понедельник, в воскресенье надо выиграть. Или просто выпить. Все можно будет сделать в ParkKing.				</div> <div class="schedule-info-block"><div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Ресторан ParkKing																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Александровский парк, д.4										<a href="#" onclick="initMap(50498);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-status schedule-available w-clearfix"><img src="/themes/b4/images/fire-color.svg" alt="" class="game-status-icon"> <div>Осталось мало мест</div></div> <div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50498, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50498" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50887" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;/files/2023%2F01%2F63c526b1e2487.png&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    22 января, Воскресенье			</div> <div class="schedule-block-top"><a href="/game-page?id=50887" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Кино и TV [стрим] 90-е vs 2000-е SPB</div> <div class="h2 h2-game-card ">#1</div></a> <div class="techtext techtext-mb30">Айс или не айс? Вот в чем вопрос…				</div> <div class="schedule-info-block"><div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Везде, где есть интернет																			</div></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 20:00</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">1000₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с команды</div> <div>оплата онлайн</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50887, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50887" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50499" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;/files/media_old/qp_files_30.png&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    24 января, Вторник			</div> <div class="schedule-block-top"><a href="/game-page?id=50499" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">[кино и музыка] SPB</div> <div class="h2 h2-game-card ">#103</div></a> <div class="techtext techtext-mb30">2 часа интеллектуальной дискотеки: вопросы только про кино и музыку. Единственное место, где русский рэп может встретиться с Шопеном, а победят не самые умные, а те, кто больше сериалов посмотрел.				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Grand Bianco																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Набережная канала Грибоедова, д. 36										<a href="#" onclick="initMap(50499);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50499, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50499" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50833" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    24 января, Вторник			</div> <div class="schedule-block-top"><a href="/game-page?id=50833" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card ">#613</div></a> <div class="techtext techtext-mb30">Во вторник может случиться все, что угодно! Вы даже можете выиграть в интеллектуальной игре, где вас ждут множество интересных вопросов на самые разные темы, обаятельный ведущий, толпа соперников, настоящий дух битвы и призы, конечно.				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Puberty																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">наб. Выборгская, д.47										<a href="#" onclick="initMap(50833);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50833, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50833" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50834" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;/files/2021%2F06%2F60c70fcdbfeb9.png&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    25 января, Среда			</div> <div class="schedule-block-top"><a href="/game-page?id=50834" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">[про кино] SPB</div> <div class="h2 h2-game-card ">#2</div></a> <div class="techtext techtext-mb30">Не топом единым: игра про кино и всё-всё-всё, что с ним связано. Поговорим про историю, жанры, режиссеров и, конечно, вспомним любимые (и не только) фильмы. 				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Grand Bianco																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Набережная канала Грибоедова, д. 36										<a href="#" onclick="initMap(50834);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50834, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50834" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50835" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    25 января, Среда			</div> <div class="schedule-block-top"><a href="/game-page?id=50835" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card ">#614</div></a> <div class="techtext techtext-mb30">Середина недели - самое время начать веселиться, если вы еще не. Мы вот да. Поэтому сегодня соберем толпу самых умных в ParkKing, а самые умные будут запивать свой вкусный ужин чем-то горячительным, отвечая на наши каверзные вопросы.				</div> <div class="schedule-info-block"><div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Ресторан ParkKing																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Александровский парк, д.4										<a href="#" onclick="initMap(50835);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50835, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50835" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50836" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;/files/media_old/qp_files_44.png&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    26 января, Четверг			</div> <div class="schedule-block-top"><a href="/game-page?id=50836" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">[про кино] Гарри Поттер SPB</div> <div class="h2 h2-game-card ">#2</div></a> <div class="techtext techtext-mb30">Это уже не просто магия вне Хогвартса, а настоящая специальная игра, посвященная кино-франшизе о мальчике, который выжил!				</div> <div class="schedule-info-block"><div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">ЦИНЬ																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">16 линия В.О дом 83										<a href="#" onclick="initMap(50836);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50836, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50836" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50837" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    26 января, Четверг			</div> <div class="schedule-block-top"><a href="/game-page?id=50837" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card ">#613</div></a> <div class="techtext techtext-mb30">Любой будний день можно сделать праздничным, если собраться с друзьями в баре за бокальчиком сухого и поиграть в Квиз, плиз! Особенно, если не только поиграть, но и выиграть. Четверг — не исключение.				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Grand Bianco																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Набережная канала Грибоедова, д. 36										<a href="#" onclick="initMap(50837);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50837, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50837" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50841" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;/files/2019/07/5d31b6c8ac7ad.png&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    27 января, Пятница			</div> <div class="schedule-block-top"><a href="/game-page?id=50841" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">[18+] SPB</div> <div class="h2 h2-game-card ">#6</div></a> <div class="techtext techtext-mb30">Тематическая игра 18+ для тех, кто не стесняется.				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Дворец Олимпия																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Литейный пр., д. 14										<a href="#" onclick="initMap(50841);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50841, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50841" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50838" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    27 января, Пятница			</div> <div class="schedule-block-top"><a href="/game-page?id=50838" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">[новички] SPB</div> <div class="h2 h2-game-card ">#615</div></a> <div class="techtext techtext-mb30">Если вы молоды и пока не готовы соперничать с опытными игроками, а занять призовое место хочется — эта игра для вас: играют только начинающие команды с рангом не старше сержанта.				</div> <div class="schedule-info-block"><div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">ЦИНЬ																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">16 линия В.О дом 83										<a href="#" onclick="initMap(50838);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50838, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50838" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50839" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    27 января, Пятница			</div> <div class="schedule-block-top"><a href="/game-page?id=50839" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card ">#614</div></a> <div class="techtext techtext-mb30">Грамотный кутеж начинается с аперитива и с Квиз, плиз! Классическая игра с традиционно крутыми вопросами, хорошенько поужинать и пригубить горячительного — то, что нужно.				</div> <div class="schedule-info-block"><div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Rossi's Club																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">ул. Зодчего Росси 1/3										<a href="#" onclick="initMap(50839);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50839, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50839" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50840" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    27 января, Пятница			</div> <div class="schedule-block-top"><a href="/game-page?id=50840" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card ">#615</div></a> <div class="techtext techtext-mb30">Пятница, Квиз, плиз!, PaarkKing — составляющие хорошего настроения. Можно задом наперед или в другом порядке. Подходит для всех людей от 15 до 99. Легально.				</div> <div class="schedule-info-block"><div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Ресторан ParkKing																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Александровский парк, д.4										<a href="#" onclick="initMap(50840);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50840, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50840" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50844" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;/files/media_old/qp_files_30.png&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    28 января, Суббота			</div> <div class="schedule-block-top"><a href="/game-page?id=50844" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">[кино и музыка] SPB</div> <div class="h2 h2-game-card ">#103</div></a> <div class="techtext techtext-mb30">2 часа интеллектуальной дискотеки: вопросы только про кино и музыку. Единственное место, где русский рэп может встретиться с Шопеном, а победят не самые умные, а те, кто больше сериалов посмотрел.				</div> <div class="schedule-info-block"><div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Ресторан ParkKing																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Александровский парк, д.4										<a href="#" onclick="initMap(50844);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 15:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50844, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50844" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50843" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    28 января, Суббота			</div> <div class="schedule-block-top"><a href="/game-page?id=50843" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card ">#615</div></a> <div class="techtext techtext-mb30">Выходные для души, а не для мозгов - помогаем держать в тонусе серое вещество даже в субботу. В базовой комплектации также идут вкусная еда, доступ к алкоголю, любимые друзья и атмосфера праздника.				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Grand Bianco																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Набережная канала Грибоедова, д. 36										<a href="#" onclick="initMap(50843);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 15:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50843, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50843" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50842" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;/files/2020/02/5e50e5ba06b36.png&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    28 января, Суббота			</div> <div class="schedule-block-top"><a href="/game-page?id=50842" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">[мультики] SPB</div> <div class="h2 h2-game-card ">#7</div></a> <div class="techtext techtext-mb30">Квиз, плиз! [мультики] — отличный шанс доказать всем, что вы не зря столько времени потратили на «Симпсонов» и «Рика и Морти».				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Puberty																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">наб. Выборгская, д.47										<a href="#" onclick="initMap(50842);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 16:00</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50842, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50842" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50845" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    28 января, Суббота			</div> <div class="schedule-block-top"><a href="/game-page?id=50845" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card ">#613</div></a> <div class="techtext techtext-mb30">Играем вопросы #613 в субботу в ParkKing. План следующий: собираем всех умниц под одной крышей, выясняем, кто самый умный. В программе вечера также крутые вопросы, классный ведущий, призы, подарки, шоу, восторг.				</div> <div class="schedule-info-block"><div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Ресторан ParkKing																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Александровский парк, д.4										<a href="#" onclick="initMap(50845);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50845, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50845" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50846" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;/files/2020/02/5e38319fc2081.png&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    29 января, Воскресенье			</div> <div class="schedule-block-top"><a href="/game-page?id=50846" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">[кино и музыка] 2000-х SPB</div> <div class="h2 h2-game-card ">#4</div></a> <div class="techtext techtext-mb30">На два часа окунёмся в эпоху музыкальных субкультур, великих фильмов и качовых песен — это Квиз, плиз! [кино и музыка] 2000-х, йоу-йоу-йоу!				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Grand Bianco																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Набережная канала Грибоедова, д. 36										<a href="#" onclick="initMap(50846);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 15:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50846, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50846" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50847" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    29 января, Воскресенье			</div> <div class="schedule-block-top"><a href="/game-page?id=50847" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card ">#615</div></a> <div class="techtext techtext-mb30">Воскресная битва для тех, кто не знает устали. Чтоб с настроением зайти в понедельник, в воскресенье надо выиграть. Или просто выпить. Все можно будет сделать в Puberty.				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Puberty																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">наб. Выборгская, д.47										<a href="#" onclick="initMap(50847);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 16:00</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50847, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50847" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50849" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;/files/2022%2F02%2F61f933d21156e.png&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    29 января, Воскресенье			</div> <div class="schedule-block-top"><a href="/game-page?id=50849" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">[назад в 2010-е] SPB</div> <div class="h2 h2-game-card ">#2</div></a> <div class="techtext techtext-mb30">Еще не история, но уже не современность. Речь не про спинеры, но время, подарившее нам столько всего (включая спинеры!) – 2010-е!				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Дворец Олимпия																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Литейный пр., д. 14										<a href="#" onclick="initMap(50849);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50849, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50849" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div> <div id="50848" class="schedule-column "><div class="schedule-block available" style="background-image: url(&quot;&quot;); background-size: 50%; background-position: center center; background-repeat: no-repeat no-repeat;"><div class="h3 h3-green h3-mb10 block-date-with-language-game game-active">
				    29 января, Воскресенье			</div> <div class="schedule-block-top"><a href="/game-page?id=50848" class="schedule-block-head w-inline-block"><div class="h2 h2-game-card h2-left">Квиз, плиз! SPB</div> <div class="h2 h2-game-card ">#614</div></a> <div class="techtext techtext-mb30">Завершаем неделю красиво - играем вопросы #614 в Grand Bianco. 2 часа интеллектуального побоища, интересные вопросы, дух соперничества и клевые призы смогут отвлечь от надвигающихся трудовых будней.				</div> <div class="schedule-info-block"><div class="schedule-info"><div class="techtext"><span class="text_cov"></span></div> <div id="text-popup" class="white-popup mfp-hide"></div></div> <div class="schedule-info"><img src="/themes/b4/images/pin-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext"><div class="schedule-block-info-bar">Grand Bianco																				<button class="span-yellow-link">Инфа о баре</button></div></div> <div class="techtext techtext-halfwhite">Набережная канала Грибоедова, д. 36										<a href="#" onclick="initMap(50848);" class="span-green-link">
											    Где это?										</a></div></div></div> <div class="schedule-info"><img src="/themes/b4/images/time-halfwhite.svg" alt="" class="schedule-icon"> <div><div class="techtext">в 19:30</div></div></div> <div class="schedule-info last"><div><div class="new-price"><span class="price">400₽</span> <span class="text" style="font-size: 37px;">/</span> <div class="text"><div>с человека</div> <div>наличные или карта</div></div></div></div></div></div></div> <div class="schedule-block-bottom"><div class="game-buttons available"><a href="#" onclick="callAnalytics(null, null, ['track', 'Lead'], 'lead');sendFBAnalyticsMetric('InitiateCheckout');return Game.openModalSecond(50848, false, false ,this);" class="button button-green button-left button-small w-button customs_dis">Записаться на игру          </a> <a onclick="callAnalytics(null, null, ['track', 'ViewContent'], 'view_content');sendFBAnalyticsMetric('ViewContent');" href="/game-page?id=50848" class="button button-green button-left button-small-line w-button">Подробнее</a></div></div></div></div></div> <div id="modal-certificate" class="modal-overlay"><a href="#" title="Close (Esc)" type="button" data-w-id="a8571374-1d0c-4462-cfd6-57ce814e874c" class="mfp-close  close w-inline-block custom-close" style="z-index: 2;"></a> <div class="modal-content"><div class="modal-content__place"><div class="place__title"></div> <div class="place__address"><span><img src="/themes/b4/images/place-modal-location.svg" alt="location" class="modal__location_icon">
					    
					</span></div> <!----> <!----> <div class="place__description"></div> <div class="place__special"><img src="/themes/b4/images/place-info.svg" alt="info" class="modal__special_icon">
					
				    </div></div> <div id="modal-ymap" class="modal-content__ymap"></div></div></div> <div id="modal-content__img" class="modal-overlay"><a href="#" title="Close (Esc)" type="button" data-w-id="a8571374-1d0c-4462-cfd6-57ce814e874c" class="mfp-close  close w-inline-block custom-close" style="z-index: 2;"></a> <div id="button__control" class="buttons__control"><button id="control_btn_modal_left" class="control__btn"><div></div></button> <img src="" alt="photo_img_item" id="photo_img_item"> <button id="control_btn_modal_right" class="control__btn"><div></div></button></div></div></div>
		    
		    <div id="unixtime_hidden" unixtime=""></div>
    
		    <script>
			/** Calendar */
			const dates = new URLSearchParams(window.location.search).get('QpGameSearch[dates]')
			const selectedDates = typeof dates === 'string' && dates.length ? dates.split(',') : [];
    
			const filtersApp = new Vue({
			    el: '#filters',
			    data() {
				return {
			...
			const datesInput = document.querySelector("input[name='QpGameSearch[dates]']")
			const form = document.querySelector('#filters')
			const datesOfAllGames = ["2023-01-17","2023-01-18","2023-01-19","2023-01-20","2023-01-21","2023-01-22","2023-01-24","2023-01-25","2023-01-26","2023-01-27","2023-01-28","2023-01-29"];
    
			const dataPicker = new AirDatepicker('#calendarBlock', {
			    minDate: new Date(),
			    maxDate: datesOfAllGames[datesOfAllGames.length - 1],
			    multipleDates: true,
			    navTitles: {
				days: 'MMMM yyyy',
			    },
				...
				const _date = getFullDate(date);
				const shouldChangeContent = datesOfAllGames.includes(_date)
				return {
				    classes: isDay ? (shouldChangeContent ? 'enable-cell' : '-disabled-') : false
				}
			    },
			    selectedDates
			})
    
			function formatNumberToDecimal(data) {
			    return data > 9 ? data : '0' + data
			}
    
			/** Calendar END */
    
			const cityId = document.querySelector('.container-header.w-clearfix').dataset.cityid
			document.addEventListener('DOMContentLoaded', function() {
			    const anchor = document.querySelector('.place__address > span')
			    if (anchor) {
				anchor.onclick = e => {
				    e.preventDefault()
				    document.querySelector('.modal-content__ymap').scrollIntoView({
					behavior: 'smooth',
					block: 'start'
				    })
				}
			...
			const addEmptyDivInSlider = () => {
			    const imagesWrapper = document.querySelector('.images__wrapper')
			    if (!!imagesWrapper && !!imagesWrapper.children) {
				const widthLastElem = imagesWrapper.lastElementChild.offsetWidth
				const emptyDiv = document.createElement('div')
				const wdth = imagesWrapper.offsetWidth - widthLastElem
    
				emptyDiv.style.minWidth = wdth + 'px'
				emptyDiv.className = "empty-block"
				imagesWrapper.append(emptyDiv)
			...
			// alert('Red Alert');
			var element = document.getElementById('unixtime_hidden');
			if (element instanceof HTMLElement) {
			    var unixtime = element.getAttribute('unixtime');
			    if (unixtime > 0) {
				if (unixtime > 0) {
				    setInterval(function() {
					printTime(Math.round(unixtime - Date.now() / 1e3));
					if (Math.round(unixtime - Date.now() / 1e3) < 0) {
					    document.querySelector('.schedule-timer').style.display = 'none'
					    location.reload()
					}
				    }, 1000)
			...
			function printTime(totalSeconds) {
			    ...
			    var dBlock = document.getElementById('w-timer-days');
			    dBlock.children[0].innerHTML = days;
			    dBlock.children[2].innerHTML = Rus(days, 'День', 'Дня', 'Дней');
			    // dBlock.hidden = days === 0;
    
			    var hBlock = document.getElementById('w-timer-hours');
			    hBlock.children[0].innerHTML = hours;
			    hBlock.children[1].innerHTML = Rus(hours, 'Час', 'Часа', 'Часов');
			    // hBlock.hidden = hours === 0;
    
			    var mBlock = document.getElementById('w-timer-minutes');
			    mBlock.children[0].innerHTML = minutes;
			    mBlock.children[1].innerHTML = Rus(minutes, 'Минута', 'Минуты', 'Минут');
			    // mBlock.hidden = minutes === 0;
    
    
			    var sBlock = document.getElementById('w-timer-seconds');
			    sBlock.children[0].innerHTML = seconds;
			    sBlock.children[1].innerHTML = Rus(seconds, 'Секунда', 'Секунды', 'Секунд');
			    // sBlock.hidden = seconds === 0;
			}
    
    
			function Rus(n, one, some, many) {
			    n = n % 100;
			    if (n > 10 && n < 20) {
				return many;
			    } else if (n % 10 == 1) {
				return one;
			    } else if ([2, 3, 4].indexOf(n % 10) > -1) {
				return some
			    }
			    return many
			}
			...
			const vue = new Vue({
				...
				prevImage() {
				    this.imageIndex = this.imageIndex === 0 ? this.place.photos.length - 1 : --this.imageIndex
				    this.scrollToImage()
				},
				nextImage() {
				    this.imageIndex = this.imageIndex === this.place.photos.length - 1 ? 0 : ++this.imageIndex
				    this.scrollToImage()
				},
				prevImageModal(){
				    this.imageIndex = this.imageIndex === 0 ? this.place.photos.length - 1 : --this.imageIndex
				...
				openModalImg(src) {
				    this.$refs.modal_img.classList.add('active')
				    this.$refs.photo_img_item.src = src
				},
				closeModalImg() {
				    this.$refs.modal_img.classList.remove('active')
				},
				setImage(e, index) {
				    this.imageIndex = index
				    this.scrollToImage()
				    this.openModalImg(e.target.src)
				},
				setImgModal(){
				    const target = this.$refs.imageContainer.childNodes[this.imageIndex]
				    this.$refs.photo_img_item.src = target.firstChild.src
				...
				async fetchGame(id) {
				    if (id != this.id) {
					let res = await fetch('/ajax/scope-game?id=' + id)
				...
				drawMap() {
				    const mapType = this.place.map_type
				    if (mapType === 'google') {
					this.drawGoogleMap()
				...
				drawYandexMap() {
				    const placeMap = this.place
				    ymaps.ready(function() {
					const address = placeMap.cityName + ' ' + placeMap.address
					...
					geocoder.then(res => {
					    ...
					    const map = new ymaps.Map('modal-ymap', {
					    ...
					    map.events.add('dblclick', e => e.preventDefault())
					    this.map = map
					})
				    })
				},
				drawGoogleMap() {
				    ...
				    const map = new google.maps.Map(document.getElementById("modal-ymap"), {
					center: latlng,
					zoom: 14,
				    })
	    ...
	    <footer>
	<!-- TODO: use ant-container -->
	<div class="container">
	<div class="ant-row">
	    <button class="footer-button" onclick="return scrollToUp()"><img src="/img/toup.svg" alt="наверх">наверх</button>
	</div>
	    <div class="ant-row">
		<div class="ant-col-xl-2 ant-col-lg-2 ant-hidden-md ant-hidden-sm ant-hidden-xs">
		    <div class="footer-logo">
			<a href="/">
			    <img src="/img/logo.svg" alt="Картинка" class="img-responsive">
			</a>
		    </div>
		</div>
		<div class="ant-col-xl-10 ant-col-lg-10 ant-col-md-12 ant-col-sm-12 ant-col-xs-12">
		    <div class="ant-row">
    
			<div class="ant-col-xl-12 ant-col-lg-12 ant-col-md-12 ant-col-sm-12 ant-col-xs-12">
			    <nav class="footer-nav">
				<ul>
				    <li><a href="https://franch.quizplease.ru">Франшиза</a></li>
				    <li><a href="/rating">Рейтинг команд</a>
				    </li>
				    <li><a href="/schedule" class="w--current">Расписание</a>
				    </li>
		    ...
		    <div class="ant-row">
			<div class="ant-col-xl-6 ant-col-lg-6 ant-col-md-6 ant-col-sm-6 ant-col-xs-6">
			    <div class="footer-contact">
				<p>Любые вопросы по играм</p>
				<ul>
				    <li>
					<a href="mailto:spb@quizplease.ru">spb@quizplease.ru</a>
				    </li>
				    <li>
					<a class="footer-phone" href="tel:+7 812 603-47-67"> +7 812 603-47-67</a>
				    </li>
				</ul>
			    </div>
			</div>
			<div class="ant-col-xl-6 ant-col-lg-6 ant-col-md-6 ant-col-sm-6 ant-col-xs-12  end-xl end-lg end-md end-sm end-xs">
			    <div class="ant-row">
				<div class="ant-hidden-xl ant-hidden-lg ant-col-md-12 ant-col-sm-12 ant-col-xs-12">
				    <div class="footer-logo">
					<a href="/">
					    <img src="/img/logo.svg" alt="Картинка" class="img-responsive">
					</a>
				...
				<div class="ant-col-xl-12 ant-col-lg-12 ant-col-md-12 ant-col-sm-12 ant-col-xs-12 footer-icons">
				    <div class="footer-soc">
					<ul style="display: flex; align-items: center">
																	<li>
							<a target="_blank" class="wrapperIcon" onclick="yaCounter35711540.reachGoal('ClickVK');ga('send', 'event', 'ClickVK', 'click');" href="https://vk.com/quizplease_spb">
								...
								<path class="st0" d="M13.162 18.994c.609 0 .858-.406.851-.915-.031-1.917.714-2.949 2.059-1.604 1.488 1.488 1.796 2.519 3.603 2.519h3.2c.808 0 1.126-.26 1.126-.668 0-.863-1.421-2.386-2.625-3.504-1.686-1.565-1.765-1.602-.313-3.486 1.801-2.339 4.157-5.336 2.073-5.336h-3.981c-.772 0-.828.435-1.103 1.083-.995 2.347-2.886 5.387-3.604 4.922-.751-.485-.407-2.406-.35-5.261.015-.754.011-1.271-1.141-1.539-.629-.145-1.241-.205-1.809-.205-2.273 0-3.841.953-2.95 1.119 1.571.293 1.42 3.692 1.054 5.16-.638 2.556-3.036-2.024-4.035-4.305-.241-.548-.315-.974-1.175-.974h-3.255c-.492 0-.787.16-.787.516 0 .602 2.96 6.72 5.786 9.77 2.756 2.975 5.48 2.708 7.376 2.708z"></path>
											...
											<li>
					      <a target="_blank" class="wrapperIcon" href="https://t.me/quizplease_spb">
				...
				<div class="ant-col-xl-12 ant-start-xl ant-start-lg ant-start-md hidden-sm hidden-xs">
				    <div class="footer-agreement">
					<a target="_blank" href="/agreement">Соглашение на обработку персональных данных и получение рассылки</a>
				    </div>
				</div>
			    </div>
			</div>
		    </div>
		    <div class="ant-col-sm-12  ant-col-xs-12 ant-center-sm ant-center-xs hidden-xl hidden-lg hidden-md">
			<div class="footer-agreement">
			    <a target="_blank" href="/agreement">Соглашение на обработку персональных данных и получение рассылки</a>
			</div>
		    </div>
	...
	const scrollToUp = () => {
		...
		timeOut = setTimeout('scrollToUp()',5);
		...
		<script type="text/javascript">
			...
			(w[c] = w[c] || []).push(function () {
			    try {
				w.yaCounter35711540 = new Ya.Metrika({
				    id: 35711540,
				    clickmap: true,
				    trackLinks: true,
				...
				w.yaCounter80130940 = new Ya.Metrika({
				    id: 80130940,
				    clickmap: true,
				    trackLinks: true,
				    accurateTrackBounce: true,
				});
				w.yaCounter88758191 = new Ya.Metrika({
			    id: 88758191,
			    clickmap: true,
			    trackLinks: true,
			    accurateTrackBounce: true,
		...
		<noscript>
		    &lt;div&gt;
			&lt;img src="https://mc.yandex.ru/watch/35711540" style="position:absolute; left:-9999px;" alt=""/&gt;
			&lt;img src="https://mc.yandex.ru/watch/80130940" style="position:absolute; left:-9999px;" alt=""/&gt;
		    &lt;/div&gt;
		</noscript>
		<!-- /Yandex.Metrika counter -->
	    <!-- Tiktok Pixel -->
    ...
    ta.src = 'https://analytics.tiktok.com/i18n/pixel/sdk.js?sdkid=BSLTES8FTC5NUJCR9HH0';
    ...
    <script src="/assets/72b6f059/js/bootstrap.min.js"></script>
    <script src="/assets/ad300215/yii.js"></script>
    <script src="//cdn.jsdelivr.net/npm/yii2-pjax@2.0.7/jquery.pjax.min.js"></script>
    <script src="/assets/ad300215/yii.activeForm.js"></script>
    <script src="/themes/b4/js/jquery.barrating.js"></script>
    <script src="/themes/b4/js/webflow5.js"></script>
    <script src="/libs/magnific-popup/jquery.magnific-popup.min.js?"></script>
    <script src="/libs/ion.rangeSlider.min.js"></script>
    <script src="/libs/slick/slick.min.js"></script>
    <script src="/themes/b4/js/evaluation2.js?31082020"></script>
    <script src="/themes/b4/js/common_3_3.js?17112021"></script>
    <script src="/js/game5_1.js?v=5"></script>
    <script src="/libs/intl-tel-17/js/intlTelInput.min.js"></script>
    <script src="/themes/b4/js/city-popup2.js?29052020"></script>
    <script>jQuery(function ($) {
    
	    var teamNameInput = $(".teamName")
	    var haveCertificate = $(".have-certificate__js")
	    var haveCertificateLabel = $(".have-certificate-label__js")
	    var certificates = $(".certificates__wrapper")
	    var responseMsg = $(".response-msg")
	    var gameIdInput = $(".game-id-input")
	    var promoCodeInputWrapper = $(".promo-code__input__wrapper")
	    var toPay = document.querySelector(".toPay")
    
	    var responseMsgTitle = $(".response-msg__title_success")
	    var responseMsgSuccess = $(".response-msg_success")
	    var promoCodeSuccessWrapper = $(".success-wrapper")
	    window.repeatPromo = false
	    window.typePromoCode = null
	    window.buttonCancel = null
	    window.promik = null
	    
	    var certificate = $(".certificate__js")
	    var certificateButton = $(".certificate__button__js")
	    var certificateInput = $(".certificate__input__js")
	    var certificateResponseMsg = $(".certificate__response-msg")
	    var certificateInputWrapper = $(".certificate__input__wrapper")
    
	    var certificateResponseMsgTitle = $(".certificate__response-msg__title_success")
	    var certificateResponseMsgSuccess = $(".certificate__response-msg_success")
	    var certificateSuccessWrapper = $(".certificate__success-wrapper")
	    var selectedValueInp = document.querySelector("#example")
	    if (selectedValueInp) {
		selectedValueInp.onchange = () => {
		    window.renderSelectExtraPayment(true)
		}
	    }
    
	    promoCodeSuccessWrapper.hide()
	    certificateSuccessWrapper.hide()
	    
	    teamNameInput.change(function() {
		if( window.typePromoCode===1 && window.repeatPromo){
		    isChange = confirm("При изменении поля - удалятся все применненые промокоды,продолжить ?")
		    isChange? window.buttonCancel.click() : null
		}
	    })
	    
	    
	    if (!haveCertificate.is(":checked")) {
		certificates.hide()
	    }
    
	    haveCertificate.change(function() {
		if (haveCertificate.is(":checked")) {
		    certificates.show()
		}
		else {
		...
		certificateSuccessWrapper,
		certificateInputWrapper,
		certificateWrapper,
		certificateCancel,
		certificateInput
	    ) {
		window.buttonCancel = certificateCancel
		certificateSuccessWrapper.show()
		certificateInputWrapper.hide()
		successFlag = true
		certificateCancel.click(function(e){
		    countCertificate = document.getElementsByClassName("certificate")
		    if( countCertificate.length > 1 ){
			certificateWrapper.remove()
		    }
		    window.typePromoCode = null
		    window.repeatPromo = false
		    if(window.offlinePay){
			document.querySelector(".form-button__js").value = "Записаться на игру"
		    } else{
			
			document.querySelector(".form-button__js").value = "Оплатить игру"
		    }
		    e.preventDefault()
		    certificateSuccessWrapper.hide()
		    certificateInputWrapper.show()
		    certificateInput.val("")
		    successFlag = false
		    certificateInput.attr("data-count", 0)
		    window.promocodePeople = 0
		    window.renderSelectExtraPayment(true)
		})
	    }
		...
		certificateInput,
		certificateResponseMsgTitle,
		certificateResponseMsgSuccess,
		value,
		data,
		certificateSuccessWrapper,
		certificateInputWrapper,
		...
		window.typePromoCode = data.use_type
		window.repeatPromo = true
		
		certificateResponseMsg.text("")
		...
		certificateResponseMsgTitle.text("Промокод " + value + " активирован!")
		certificateResponseMsgSuccess.text(data.message)
		
		if (firstTime) {
		    certificateInput.attr("data-count", (data.promo_type + "")[0])
		    window.renderSelectExtraPayment(true)
		}
		resolve()
	    }
    
	    certificateButton.each(function() {
		$(this).on("click", function(e) {
		    e.preventDefault()
		    generalValidator(true,true,this)
		})
	    ...
	    function checkSameCertificate(query) {
		const inputs = document.querySelectorAll(".certificate__input__js")
		const values = []
    
		for (input of Array.from(inputs)) {
		    values.push(input.value.trim())
		}
		return values.filter(value => value === query).length
	    }
		...
		var certificateWrapper = $(context).closest(".certificate")
		var certificateResponseMsg = certificateWrapper.find(".certificate__response-msg")
		var certificateInput = certificateWrapper.find(".certificate__input__js")          
		
		var certificateResponseMsgTitle = certificateWrapper.find(".certificate__response-msg__title_success")
		var certificateResponseMsgSuccess = certificateWrapper.find(".certificate__response-msg_success")
		
		var certificateSuccessWrapper = $(context).closest(".certificate").find(".certificate__success-wrapper")
		var certificateInputWrapper = $(context).closest(".certificate__input__wrapper")
		var certificateCancel = $(context).closest(".certificate").find(".certificate-cancell")
    
		certificateResponseMsg.text("")
    
		const value = certificateInput.val() ? certificateInput.val().trim() : ""
		value? window.promik=value : null
		const teamName = teamNameInput.val().trim()
		
		const count = checkSameCertificate(certificateInput.val())
		
		return new Promise(function (resolve, reject){
		    $.get("/ajax/check-code", {game_id: gameIdInput.val(), code: window.promik, name: teamName,useCount:count})
		    .done(function( data ) {
			if( data.success ){    
			    ...
			    } else if(data.type === "promo" && !window.repeatPromo) {
				certificateInput.attr("name","promo_code")
				promoCodeValidator(
				    firstTimePromo, 
				    certificateResponseMsg,
				    certificateInput,
			    ...
			    } else if(window.repeatPromo){
				certificateInput.val("")
				certificateResponseMsg.text("Упс, вы можете воспользоваться только одним промокодом.")
				resolve()
			    }
			}
			else{
			    certificateInput.val("")
			    certificateResponseMsg.text(data.message)
			    resolve()
			}
		    })
		    .always(function(){
		...
		certificateInput.attr("name","certificates[]")
		if (!window.certPeople) {
		    window.certPeople = 0
		}
		const gameType = $(".schedule-block-info-price").data("certificate_type", data.certificate_type)
		
		certificateShowSuccess(
		    certificateSuccessWrapper,
		    certificateInputWrapper,
		    certificateWrapper,
		    certificateCancel,
		...
		certificateResponseMsgSuccess.text("")
		certificateResponseMsgTitle.text(data.message)
		document.querySelector(".form-button__js").value = "Записаться на игру"
		certificateInput.attr("data-count", (data.certificate_type + "")[0])
		certificateInput.val(value)
		const onlyOnSpotTypes = [0,1,2]
		if (firstTime) {
		    window.certPeople += +(data.certificate_type + "")[0]
		    window.renderSelectExtraPayment(!onlyOnSpotTypes.includes(gameType))
		}
		if (data.game_format === 1) {
		    document.querySelector(".add_certificate-field").style.display = "none"
		    document.querySelector(".toPay").style.display = "none"
		}
		
		resolve()
	    }
    
	    var certificateSuccessFlag = false
	    function certificateShowSuccess (
		certificateSuccessWrapper,
		certificateInputWrapper,
		certificateWrapper,
		certificateCancel,
		...
		certificateSuccessWrapper.show()
		certificateInputWrapper.hide()
		certificateSuccessFlag = true
		certificateCancel.click(function(e){
		    const countCertificate = document.getElementsByClassName("certificate")
		    if( countCertificate.length > 1 ){
			certificateWrapper.remove()
		    }
		    if(window.offlinePay){
	...
	var teamName = $("#qprecord-teamname")
	var captainName = $("#qprecord-captainname")
	var email = $("#qprecord-email")
	var phone = $("#qprecord-phone-16")
	...
	captainName.blur(function(){
	    captainNameValidator()
	})
	email.blur(function(){
	    emailValidator()
	})
	...
	function showStatus(status, element, errorMessage) {
	    element.removeClass("ant-input_success")
	    element.removeClass("ant-input_error")
	    element.siblings(".ant-error").detach()
	    if (status) {
		element.addClass("ant-input_success")
	    } else {
		element.addClass("ant-input_error")
		element.after("<span class='ant-error'>" + errorMessage + "</span>")
	    }
	}
	...
	function emailValidator() {
	    var valid = false
	    var errorMessage = "Без емейла, увы, никак"
	    var regex = /^(([^<>()\[\]\.,—;:\s@"]+(\.[^<>()\[\]\.,—;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/
	    if (email.val().length > 0 && email.val().trim()) {
		errorMessage = "Это не похоже на настоящий e-mail"
		if(regex.test(email.val().trim())) {
		    valid = true
		}
	    }
	    showStatus(valid, email, errorMessage)
	    return valid
	}
    
	const uniteCustomFields = () => {
	    const inputs = document.getElementsByClassName("custom")
	    const fields = []
	    for (let i = 0; i < inputs.length; i++) {
		    fields.push({
			    name: inputs[i].getAttribute("data-field-name"),
			    type: inputs[i].type,
			    label: inputs[i].title,
			    placeholder: inputs[i].placeholder,
			    value: inputs[i].value
		    })
	    }
    
	    document.getElementById("custom-fields-final").value = JSON.stringify(fields)
	}
	
    
	function formSubmit() {
	    uniteCustomFields()
	    // сбрасывает "оплатить за"
	    const isOfflinePayment = form[0].elements["QpRecord[payment_type]"] && +form[0].elements["QpRecord[payment_type]"].value === 2
	    const surcharge = document.querySelector("#surcharge")
    
	    if (isOfflinePayment && surcharge) {
		surcharge.value = null
	    } 
	    if (!isOfflinePayment) {
		callAnalytics(null, null, ['track', 'AddPaymentInfo'], 'add_payment_info')
	    }
	    const vkPixel = "VK-RTRG-425456-6vG4p";
	    try {
		if (vkPixel) {
		    VK.Retargeting.Init(vkPixel)
		    VK.Retargeting.Event("complete-registration")
		}
		ga("send", "event", "TeamsRegistryCounter", "click")
		    !function(f,b,e,v,n,t,s)
		    {if(f.fbq)return;n=f.fbq=function(){n.callMethod?
		    n.callMethod.apply(n,arguments):n.queue.push(arguments)};
		    if(!f._fbq)f._fbq=n;n.push=n;n.loaded=!0;n.version="2.0";
		    ...
		    "https://connect.facebook.net/en_US/fbevents.js");
		    fbq("init", "1953660694758081");
		    callAnalytics(null, null, ['track', "SubmitApplication"], 'submit_application')
	    } catch(e) {
		console.error(e)
	    }
		form.submit();
	...
	function disableFormButton () {
	    ...
	    formButton.addClass("button-disabled")
	}
	...
	function formValidator() {
	    ...
	    if (teamNameValidator() && captainNameValidator() && emailValidator() && phoneValidator()) {
		sendFBAnalyticsMetric("SubmitApplication")
		formSubmit()
	    } else {
		resetFormButton()
	    }
	...
	formButton.click(function(e) {
	    ...
	    const nodes = Array.from(document.querySelectorAll(".certificate__input__js"))
	    const emptyInputs = nodes.filter(node => node.dataset.count === 0 + "")
	    if(emptyInputs.length){
		countCertificate = document.getElementsByClassName("certificate")
		emptyInputs.forEach(item =>{
		    // item.value = ""
		    if( countCertificate.length > 1 ){
			item.closest(".certificate").remove()
		    }
		})
	    }
	    ...
	    e.preventDefault()
	    uniteCustomFields()
	    if (certificateInput.val().trim() === "") {
		disableFormButton()
		formValidator()
	    } 
	    else {
		generalValidator(false, false).then(function() {
		    if (certificateSuccessFlag || successFlag) {
			disableFormButton()
			formValidator()
		    }
		})
	...
	function phoneValidator() {
	    // phoneInput.classList.remove("ant-input_success")
	    // phoneInput.classList.remove("ant-input_success")
	    // if (document.querySelector("#phone-error-message")) {
	    //     document.querySelector("#phone-error-message").remove()
	    // } 
	    var valid = false
	    var errorMessage = "Нам нужен Ваш номер"
	    if (phoneInput.value.length > 0 && phoneInput.value.trim()) {
		if (itiPhoneInput.isValidNumber()) {
		    valid = true
		} else {
		    const errorMap = {
		      0: "Некорректный номер",
		      1: "Некорректный код страны",
		      2: "В номере телефона не хватает символов",
		      3: "В номере телефона слишком много символов",
		      4: "Некорректный номер",
		      "-99": "Некорректный номер"
		    };
		    const errorCode = itiPhoneInput.getValidationError();
		    errorMessage = errorMap[errorCode];
		}
	    }
	    // if (valid) {
	    //     phoneInput.classList.add("ant-input_success")
	    // } else {
	    //     phoneInput.classList.add("ant-input_error")
	    //     const phoneContainer = document.querySelector(".phoneContainer")
	    //     phoneContainer.insertAdjacentHTML("beforeend","<span id='phone-error-message' class='ant-error'>" + errorMessage + "</span>")
	    // }
    
	    showStatus(valid, phone, errorMessage)
	    return valid
	}
    
	
	    /**
	     * New phone number validete
	     **/
	    let phoneInput = document.querySelector("#qprecord-phone-16");
    
	    // initialise plugin
	    var itiPhoneInput = window.intlTelInput(phoneInput, {
		autoHideDialCode: false,
		nationalMode: false,
		numberType: "MOBILE",
		formatOnDisplay: true,
		preferredCountries: ["ru","us","il","kz","gb","ca","by","lv","cy","uz","","","cn","de","kg","","am","","","","id","th","az"],
	    });
		...
		if (itiPhoneInput.isValidNumber(phoneInput.value)) {
		    phoneInput.style.border = "solid 1px green";
		    $(".buttonPersons").removeAttr("disabled");
		    // this.classList.remove("error");
		} else {
		    // this.classList.add("error");
    
		    $(".buttonPersons").attr("disabled", "disabled");
		    phoneInput.style.border = 'solid 1px red';
		     if (typeof itiPhoneInput.getValidationError === "function") {
    //                     var errorCode = itiPhoneInput.getValidationError();
    //                     errorMsg.innerHTML = errorMap[errorCode];
		...
		if (typeof intlTelInputUtils !== "undefined") { 
		    var currentText = itiPhoneInput.getNumber(intlTelInputUtils.numberFormat.E164);
		    if (typeof currentText === "string") { 
			itiPhoneInput.setNumber(currentText); 
		    }
		}
	      }
	    
	    // // on keyup / change flag: reset
	    phoneInput.addEventListener("change", resetIntlTelInput);
	    phoneInput.addEventListener("keyup", resetIntlTelInput);
    
	    /**
	     * End new phone number validate
	     **/
	  $('#example').barrating({
	    theme: 'bars-square',
	    showValues: true,
    ...
    jQuery(document).on("submit", "#p0 form[data-pjax]", function (event) {jQuery.pjax.submit(event, {"push":true,"replace":false,"timeout":1000,"scrollTo":false,"container":"#p0"});});
							    ...
							    $('.scheduleLeft-filter').on('change', 'select, input', function(e) {
				    const barType = 'QpGameSearch[bars][]'
					const gameType = 'QpGameSearch[type][]'
					const gameStatus =  'QpGameSearch[status][]'
					const gameFormat = 'QpGameSearch[format][]'
					const allChecBox = document.querySelectorAll('input[type=checkbox]');
					const arrayType = [];
					const arrayBars = [];
					const arrayStatus = [];
					const arrayFormat = [];
					allChecBox.forEach((item) => {
					    if (item.name === gameType) {
						arrayType.push(item);
					    }
					    if(item.name === barType){
						arrayBars.push(item);
					    }
					    if(item.name === gameStatus){
						arrayStatus.push(item);
					    }
					    if(item.name === gameFormat){
					...
					function checkAll(array) {
					   ...
					   const checkCheckedArray = array.filter((item) => item.checked && item.value !== 'all');
					    if(checkCheckedArray.length === array.length -1){
					       array[0].checked = true;
					    }
					}
				       if(e.target.name === gameType){
					    checkAll(arrayType);
					} else if(e.target.name === barType){
					    checkAll(arrayBars);
					} else if(e.target.name === gameStatus){
					    checkAll(arrayStatus);
					} else if(e.target.name === gameFormat){
					    checkAll(arrayFormat);
					}
								    if ($('.close-schedule-filter').css('display')=== 'none') {
				
									    var form = $(this).closest('form').submit();
								    }
								    $(document).ready(function() {
										    refreshIntervalId = setInterval(function(){ initMap(0) }, 1000);
								    });
							    });
    ...
    // var deadline = $('#timer').attr('data-timer');
    // initializeClock('timer', deadline);
    
    
		    $(document).ready(function(){
		    $('.header-region-active').prepend('<img src="/themes/b4/images/pin-white.svg" alt="" class="pin-icon">');
		    })
